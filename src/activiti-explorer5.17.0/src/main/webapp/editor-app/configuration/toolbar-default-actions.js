 ...
 */
'use strict';
var hlcAddr="http://192.168.0.100:8066/hlc/";
var KISBPM = KISBPM || {};
KISBPM.TOOLBAR = {
    ACTIONS: {
        ...
        closeEditor: function(services) {
            ...
            window.location.href = hlcAddr+"bizProcessConfig/bizProcessConfig_index";  
        },
...
var SaveModelCtrl = [ '$rootScope', '$scope', '$http', '$route', '$location',
    ...
    $scope.save = function (successCallback) {
        ...
        var paramsStr=url.substring(url.indexOf("?", 1)+1, url.length);
        paramsStr=paramsStr.replace(/=/g, "':").replace(/&/g, ",'")
   		params = eval("({'" + paramsStr +"})");//uid':1
