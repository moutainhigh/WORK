...
SWFUpload.prototype.initSettings = function() {
	...
	if (!this.settings.preserve_relative_urls) {
		...
		this.settings.button_image_url = this.settings.button_image_url = this.settings.button_image_url ? SWFUpload.completeURL(this.settings.button_image_url) :  this.settings.button_image_url
	}
