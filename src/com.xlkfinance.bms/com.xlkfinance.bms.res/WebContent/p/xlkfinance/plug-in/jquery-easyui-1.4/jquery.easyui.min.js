...
(function($) {
				...
				for (var j = 0; j < cols.length; j++) {
					...
					if (col.checkbox) {
						...
						if (col.field) {
							...
							cell.addClass(col.cellClass).css(
									"width",
	...
	var _711 = {
		render : function(_712, _713, _714) {
			...
			if (rows.length) {
				for (var i = 0; i < rows.length; i++) {
					var css = opts.rowStyler ? opts.rowStyler.call(_712, i,
							rows[i]) : "";
					var _718 = "";
					var _719 = "";
					if (typeof css == "string") {
					...
					var _71b = _715.rowIdPrefix + "-" + (_714 ? 1 : 2) + "-"
							+ i;
					_717.push("<tr id=\"" + _71b + "\" datagrid-row-index=\""
							+ i + "\" " + cls + " " + _71a + ">");
