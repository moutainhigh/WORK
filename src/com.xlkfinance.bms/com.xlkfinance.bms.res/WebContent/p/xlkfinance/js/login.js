$(document).ready(function() {
	...
	$('.on_off_checkbox').click(function(e){
		if(this.val() == '1'){
			this.val('0');
		}else {
			this.val('1');
...
function submit(){
	var b = new Base64();
    $('#userNameBase').val(b.encode($('#userName').val()));
    $('#passwordBase').val(b.encode($('#password').val()));
	var submit = true;
...
function setLocalStorge(){
	if(window.localStorage){
		var checked = $("#on_off").attr("checked");
		if('checked' == checked){
