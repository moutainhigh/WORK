	...
	$(document).ready(function() {
		$("#partnerForm").validate({
			...
			submitHandler : function(form) {
				$.ajax({
				    url: "${ctx}partnerController/ignore/partnerRegister.action",
				    type: "POST",
 ...
 <div class="gray-bg dashbard-1">
   ...
   <div class="ibox float-e-margins">
    ...
    <div class="ibox-content ibox-line">
     <div class="row">
      <div class="col-sm-12">
        <form role="form" id="partnerForm" class="form-horizontal" action="#" method="post">
        ...
        <div class="form-group">
         ...
         <div class="col-sm-4">
          ...
          <span style="display: none; color: red;" id="msgCodeErr"><span class="requiredSty">*</span>请输入验证码</span>
         </div>
        </div>
        <div class="form-group">
         <label for="orgUserInfo.email" class="col-sm-3 control-label"><span class="requiredSty">*</span>邮箱:</label>
         <div class="col-sm-4">
          <input type="text" class="form-control" id="email" name="orgUserInfo.email" placeholder="邮箱" maxlength="30">
         </div>
        </div>
        <div class="form-group">
