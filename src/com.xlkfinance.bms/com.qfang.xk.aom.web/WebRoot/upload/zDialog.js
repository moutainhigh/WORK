...
Dialog.prototype.attachBehaviors = function () {
    if (this.Drag && topWin.Drag) topWin.Drag.init($id("_Draghandle_" + this.ID), $id("_DialogDiv_" + this.ID)); //注册拖拽方法
...
'
    ...
    if (this.URL) {
        ...
        if (this.innerFrame.attachEvent("onload", innerFrameOnload)) {
