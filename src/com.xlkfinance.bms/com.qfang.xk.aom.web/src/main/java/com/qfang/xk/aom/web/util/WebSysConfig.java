...
public class WebSysConfig {
   ...
   public String getAomRpcPackage() {
      return aomRpcPackage;
   }

   public void setAomRpcPackage(String aomRpcPackage) {
      this.aomRpcPackage = aomRpcPackage;
   }
}
