...
public class OrgCooperationContractService {

  public interface Iface {

    public List<OrgCooperationContract> getAll(OrgCooperationContract orgCooperationContract) throws org.apache.thrift.TException;

    public OrgCooperationContract getById(int pid) throws org.apache.thrift.TException;

    public OrgCooperationContract getByOrgIdAndType(int orgId, int contractType) throws org.apache.thrift.TException;

    public int insert(OrgCooperationContract orgCooperationContract) throws org.apache.thrift.TException;

    public int update(OrgCooperationContract orgCooperationContract) throws org.apache.thrift.TException;
  ...
  public interface AsyncIface {
    ...
    public void getAll(OrgCooperationContract orgCooperationContract, org.apache.thrift.async.AsyncMethodCallback resultHandler) throws org.apache.thrift.TException;
    ...
    public void getByOrgIdAndType(int orgId, int contractType, org.apache.thrift.async.AsyncMethodCallback resultHandler) throws org.apache.thrift.TException;

    public void insert(OrgCooperationContract orgCooperationContract, org.apache.thrift.async.AsyncMethodCallback resultHandler) throws org.apache.thrift.TException;

    public void update(OrgCooperationContract orgCooperationContract, org.apache.thrift.async.AsyncMethodCallback resultHandler) throws org.apache.thrift.TException;
  ...
  public static class Client extends org.apache.thrift.TServiceClient implements Iface {
    ...
    public List<OrgCooperationContract> getAll(OrgCooperationContract orgCooperationContract) throws org.apache.thrift.TException
    {
      send_getAll(orgCooperationContract);
      return recv_getAll();
    }

    public void send_getAll(OrgCooperationContract orgCooperationContract) throws org.apache.thrift.TException
    {
      getAll_args args = new getAll_args();
      args.setOrgCooperationContract(orgCooperationContract);
      sendBase("getAll", args);
    }

    public List<OrgCooperationContract> recv_getAll() throws org.apache.thrift.TException
    {
    ...
    public OrgCooperationContract recv_getById() throws org.apache.thrift.TException
    {
    ...
    public OrgCooperationContract getByOrgIdAndType(int orgId, int contractType) throws org.apache.thrift.TException
    {
      send_getByOrgIdAndType(orgId, contractType);
      return recv_getByOrgIdAndType();
    }

    public void send_getByOrgIdAndType(int orgId, int contractType) throws org.apache.thrift.TException
    {
      getByOrgIdAndType_args args = new getByOrgIdAndType_args();
      args.setOrgId(orgId);
      args.setContractType(contractType);
      sendBase("getByOrgIdAndType", args);
    }

    public OrgCooperationContract recv_getByOrgIdAndType() throws org.apache.thrift.TException
    {
      getByOrgIdAndType_result result = new getByOrgIdAndType_result();
      receiveBase(result, "getByOrgIdAndType");
      if (result.isSetSuccess()) {
        return result.success;
      }
      throw new org.apache.thrift.TApplicationException(org.apache.thrift.TApplicationException.MISSING_RESULT, "getByOrgIdAndType failed: unknown result");
    }

    public int insert(OrgCooperationContract orgCooperationContract) throws org.apache.thrift.TException
    {
      send_insert(orgCooperationContract);
      return recv_insert();
    }

    public void send_insert(OrgCooperationContract orgCooperationContract) throws org.apache.thrift.TException
    {
    ...
    public int update(OrgCooperationContract orgCooperationContract) throws org.apache.thrift.TException
    {
      send_update(orgCooperationContract);
      return recv_update();
    }

    public void send_update(OrgCooperationContract orgCooperationContract) throws org.apache.thrift.TException
    {
  ...
  public static class AsyncClient extends org.apache.thrift.async.TAsyncClient implements AsyncIface {
    ...
    public void getAll(OrgCooperationContract orgCooperationContract, org.apache.thrift.async.AsyncMethodCallback resultHandler) throws org.apache.thrift.TException {
      checkReady();
      getAll_call method_call = new getAll_call(orgCooperationContract, resultHandler, this, ___protocolFactory, ___transport);
      this.___currentMethod = method_call;
      ___manager.call(method_call);
    }

    public static class getAll_call extends org.apache.thrift.async.TAsyncMethodCall {
      private OrgCooperationContract orgCooperationContract;
      public getAll_call(OrgCooperationContract orgCooperationContract, org.apache.thrift.async.AsyncMethodCallback resultHandler, org.apache.thrift.async.TAsyncClient client, org.apache.thrift.protocol.TProtocolFactory protocolFactory, org.apache.thrift.transport.TNonblockingTransport transport) throws org.apache.thrift.TException {
        super(client, protocolFactory, transport, resultHandler, false);
        this.orgCooperationContract = orgCooperationContract;
      }
      ...
      public List<OrgCooperationContract> getResult() throws org.apache.thrift.TException {
    ...
    public static class getById_call extends org.apache.thrift.async.TAsyncMethodCall {
      ...
      public OrgCooperationContract getResult() throws org.apache.thrift.TException {
        if (getState() != org.apache.thrift.async.TAsyncMethodCall.State.RESPONSE_READ) {
          throw new IllegalStateException("Method call not finished!");
        }
        org.apache.thrift.transport.TMemoryInputTransport memoryTransport = new org.apache.thrift.transport.TMemoryInputTransport(getFrameBuffer().array());
    ...
    public void getByOrgIdAndType(int orgId, int contractType, org.apache.thrift.async.AsyncMethodCallback resultHandler) throws org.apache.thrift.TException {
      checkReady();
      getByOrgIdAndType_call method_call = new getByOrgIdAndType_call(orgId, contractType, resultHandler, this, ___protocolFactory, ___transport);
      this.___currentMethod = method_call;
      ___manager.call(method_call);
    }

    public static class getByOrgIdAndType_call extends org.apache.thrift.async.TAsyncMethodCall {
      private int orgId;
      private int contractType;
      public getByOrgIdAndType_call(int orgId, int contractType, org.apache.thrift.async.AsyncMethodCallback resultHandler, org.apache.thrift.async.TAsyncClient client, org.apache.thrift.protocol.TProtocolFactory protocolFactory, org.apache.thrift.transport.TNonblockingTransport transport) throws org.apache.thrift.TException {
        super(client, protocolFactory, transport, resultHandler, false);
        this.orgId = orgId;
      ...
      public void write_args(org.apache.thrift.protocol.TProtocol prot) throws org.apache.thrift.TException {
        prot.writeMessageBegin(new org.apache.thrift.protocol.TMessage("getByOrgIdAndType", org.apache.thrift.protocol.TMessageType.CALL, 0));
        getByOrgIdAndType_args args = new getByOrgIdAndType_args();
        args.setOrgId(orgId);
        args.setContractType(contractType);
        args.write(prot);
      ...
      public OrgCooperationContract getResult() throws org.apache.thrift.TException {
        ...
        org.apache.thrift.transport.TMemoryInputTransport memoryTransport = new org.apache.thrift.transport.TMemoryInputTransport(getFrameBuffer().array());
        org.apache.thrift.protocol.TProtocol prot = client.getProtocolFactory().getProtocol(memoryTransport);
        return (new Client(prot)).recv_getByOrgIdAndType();
      }
    }

    public void insert(OrgCooperationContract orgCooperationContract, org.apache.thrift.async.AsyncMethodCallback resultHandler) throws org.apache.thrift.TException {
      checkReady();
      insert_call method_call = new insert_call(orgCooperationContract, resultHandler, this, ___protocolFactory, ___transport);
      this.___currentMethod = method_call;
      ___manager.call(method_call);
    }
    ...
    public static class insert_call extends org.apache.thrift.async.TAsyncMethodCall {
      private OrgCooperationContract orgCooperationContract;
      public insert_call(OrgCooperationContract orgCooperationContract, org.apache.thrift.async.AsyncMethodCallback resultHandler, org.apache.thrift.async.TAsyncClient client, org.apache.thrift.protocol.TProtocolFactory protocolFactory, org.apache.thrift.transport.TNonblockingTransport transport) throws org.apache.thrift.TException {
        super(client, protocolFactory, transport, resultHandler, false);
        this.orgCooperationContract = orgCooperationContract;
      }
    ...
    public void update(OrgCooperationContract orgCooperationContract, org.apache.thrift.async.AsyncMethodCallback resultHandler) throws org.apache.thrift.TException {
      checkReady();
      update_call method_call = new update_call(orgCooperationContract, resultHandler, this, ___protocolFactory, ___transport);
      this.___currentMethod = method_call;
      ___manager.call(method_call);
    }
    ...
    public static class update_call extends org.apache.thrift.async.TAsyncMethodCall {
      private OrgCooperationContract orgCooperationContract;
      public update_call(OrgCooperationContract orgCooperationContract, org.apache.thrift.async.AsyncMethodCallback resultHandler, org.apache.thrift.async.TAsyncClient client, org.apache.thrift.protocol.TProtocolFactory protocolFactory, org.apache.thrift.transport.TNonblockingTransport transport) throws org.apache.thrift.TException {
        super(client, protocolFactory, transport, resultHandler, false);
        this.orgCooperationContract = orgCooperationContract;
      }
  ...
  public static class Processor<I extends Iface> extends org.apache.thrift.TBaseProcessor<I> implements org.apache.thrift.TProcessor {
    ...
    private static <I extends Iface> Map<String,  org.apache.thrift.ProcessFunction<I, ? extends  org.apache.thrift.TBase>> getProcessMap(Map<String,  org.apache.thrift.ProcessFunction<I, ? extends  org.apache.thrift.TBase>> processMap) {
      ...
      processMap.put("getByOrgIdAndType", new getByOrgIdAndType());
    ...
    public static class getAll<I extends Iface> extends org.apache.thrift.ProcessFunction<I, getAll_args> {
      ...
      public getAll_result getResult(I iface, getAll_args args) throws org.apache.thrift.TException {
        getAll_result result = new getAll_result();
        result.success = iface.getAll(args.orgCooperationContract);
        return result;
      }
    }
    ...
    public static class getByOrgIdAndType<I extends Iface> extends org.apache.thrift.ProcessFunction<I, getByOrgIdAndType_args> {
      public getByOrgIdAndType() {
        super("getByOrgIdAndType");
      }

      public getByOrgIdAndType_args getEmptyArgsInstance() {
        return new getByOrgIdAndType_args();
      }
      ...
      public getByOrgIdAndType_result getResult(I iface, getByOrgIdAndType_args args) throws org.apache.thrift.TException {
        getByOrgIdAndType_result result = new getByOrgIdAndType_result();
        result.success = iface.getByOrgIdAndType(args.orgId, args.contractType);
        return result;
      }
    }
    ...
    public static class insert<I extends Iface> extends org.apache.thrift.ProcessFunction<I, insert_args> {
      ...
      public insert_result getResult(I iface, insert_args args) throws org.apache.thrift.TException {
        insert_result result = new insert_result();
        result.success = iface.insert(args.orgCooperationContract);
    ...
    public static class update<I extends Iface> extends org.apache.thrift.ProcessFunction<I, update_args> {
      ...
      public update_result getResult(I iface, update_args args) throws org.apache.thrift.TException {
        update_result result = new update_result();
        result.success = iface.update(args.orgCooperationContract);
        result.setSuccessIsSet(true);
        return result;
      }
    }
  ...
  public static class AsyncProcessor<I extends AsyncIface> extends org.apache.thrift.TBaseAsyncProcessor<I> {
    ...
    public static class getAll<I extends AsyncIface> extends org.apache.thrift.AsyncProcessFunction<I, getAll_args, List<OrgCooperationContract>> {
      public getAll() {
        super("getAll");
      }
      ...
      public AsyncMethodCallback<List<OrgCooperationContract>> getResultHandler(final AsyncFrameBuffer fb, final int seqid) {
        final org.apache.thrift.AsyncProcessFunction fcall = this;
        return new AsyncMethodCallback<List<OrgCooperationContract>>() { 
          public void onComplete(List<OrgCooperationContract> o) {
            getAll_result result = new getAll_result();
            result.success = o;
            try {
      ...
      public void start(I iface, getAll_args args, org.apache.thrift.async.AsyncMethodCallback<List<OrgCooperationContract>> resultHandler) throws TException {
        iface.getAll(args.orgCooperationContract,resultHandler);
      }
    }

    public static class getById<I extends AsyncIface> extends org.apache.thrift.AsyncProcessFunction<I, getById_args, OrgCooperationContract> {
      public getById() {
        super("getById");
      }
      ...
      public AsyncMethodCallback<OrgCooperationContract> getResultHandler(final AsyncFrameBuffer fb, final int seqid) {
        final org.apache.thrift.AsyncProcessFunction fcall = this;
        return new AsyncMethodCallback<OrgCooperationContract>() { 
          public void onComplete(OrgCooperationContract o) {
            getById_result result = new getById_result();
            result.success = o;
            try {
              fcall.sendResponse(fb,result, org.apache.thrift.protocol.TMessageType.REPLY,seqid);
      ...
      public void start(I iface, getById_args args, org.apache.thrift.async.AsyncMethodCallback<OrgCooperationContract> resultHandler) throws TException {
        iface.getById(args.pid,resultHandler);
      }
    }

    public static class getByOrgIdAndType<I extends AsyncIface> extends org.apache.thrift.AsyncProcessFunction<I, getByOrgIdAndType_args, OrgCooperationContract> {
      public getByOrgIdAndType() {
        super("getByOrgIdAndType");
      }
      ...
      public void start(I iface, getByOrgIdAndType_args args, org.apache.thrift.async.AsyncMethodCallback<OrgCooperationContract> resultHandler) throws TException {
        iface.getByOrgIdAndType(args.orgId, args.contractType,resultHandler);
      }
    }
    ...
    public static class insert<I extends AsyncIface> extends org.apache.thrift.AsyncProcessFunction<I, insert_args, Integer> {
      ...
      public void start(I iface, insert_args args, org.apache.thrift.async.AsyncMethodCallback<Integer> resultHandler) throws TException {
        iface.insert(args.orgCooperationContract,resultHandler);
      }
    }
    ...
    public static class update<I extends AsyncIface> extends org.apache.thrift.AsyncProcessFunction<I, update_args, Integer> {
      ...
      public void start(I iface, update_args args, org.apache.thrift.async.AsyncMethodCallback<Integer> resultHandler) throws TException {
        iface.update(args.orgCooperationContract,resultHandler);
      }
    }
  ...
  public static class getAll_args implements org.apache.thrift.TBase<getAll_args, getAll_args._Fields>, java.io.Serializable, Cloneable, Comparable<getAll_args>   {
    ...
    private static final org.apache.thrift.protocol.TField ORG_COOPERATION_CONTRACT_FIELD_DESC = new org.apache.thrift.protocol.TField("orgCooperationContract", org.apache.thrift.protocol.TType.STRUCT, (short)1);
    ...
    public OrgCooperationContract orgCooperationContract; // required

    /** The set of fields this struct contains, along with convenience methods for finding and manipulating them. */
    public enum _Fields implements org.apache.thrift.TFieldIdEnum {
      ORG_COOPERATION_CONTRACT((short)1, "orgCooperationContract");
      ...
      public static _Fields findByThriftId(int fieldId) {
        switch(fieldId) {
          case 1: // ORG_COOPERATION_CONTRACT
            return ORG_COOPERATION_CONTRACT;
          default:
            return null;
        }
      }
    ...
    static {
      ...
      tmpMap.put(_Fields.ORG_COOPERATION_CONTRACT, new org.apache.thrift.meta_data.FieldMetaData("orgCooperationContract", org.apache.thrift.TFieldRequirementType.DEFAULT, 
          new org.apache.thrift.meta_data.StructMetaData(org.apache.thrift.protocol.TType.STRUCT, OrgCooperationContract.class)));
    ...
    public getAll_args(
      OrgCooperationContract orgCooperationContract)
    {
      this();
      this.orgCooperationContract = orgCooperationContract;
    }
    ...
    public getAll_args(getAll_args other) {
      if (other.isSetOrgCooperationContract()) {
        this.orgCooperationContract = new OrgCooperationContract(other.orgCooperationContract);
      }
    }
    ...
    @Override
    public void clear() {
      this.orgCooperationContract = null;
    }

    public OrgCooperationContract getOrgCooperationContract() {
      return this.orgCooperationContract;
    }

    public getAll_args setOrgCooperationContract(OrgCooperationContract orgCooperationContract) {
      this.orgCooperationContract = orgCooperationContract;
      return this;
    }

    public void unsetOrgCooperationContract() {
      this.orgCooperationContract = null;
    }

    /** Returns true if field orgCooperationContract is set (has been assigned a value) and false otherwise */
    public boolean isSetOrgCooperationContract() {
      return this.orgCooperationContract != null;
    }

    public void setOrgCooperationContractIsSet(boolean value) {
      if (!value) {
        this.orgCooperationContract = null;
      }
    }
    ...
    public void setFieldValue(_Fields field, Object value) {
      switch (field) {
      case ORG_COOPERATION_CONTRACT:
        if (value == null) {
          unsetOrgCooperationContract();
        } else {
          setOrgCooperationContract((OrgCooperationContract)value);
        }
        break;
    ...
    public Object getFieldValue(_Fields field) {
      switch (field) {
      case ORG_COOPERATION_CONTRACT:
        return getOrgCooperationContract();
    ...
    public boolean isSet(_Fields field) {
      ...
      switch (field) {
      case ORG_COOPERATION_CONTRACT:
        return isSetOrgCooperationContract();
      }
      throw new IllegalStateException();
    }
    ...
    public boolean equals(getAll_args that) {
      ...
      boolean this_present_orgCooperationContract = true && this.isSetOrgCooperationContract();
      boolean that_present_orgCooperationContract = true && that.isSetOrgCooperationContract();
      if (this_present_orgCooperationContract || that_present_orgCooperationContract) {
        if (!(this_present_orgCooperationContract && that_present_orgCooperationContract))
          return false;
        if (!this.orgCooperationContract.equals(that.orgCooperationContract))
          return false;
      }
    ...
    public int hashCode() {
      ...
      boolean present_orgCooperationContract = true && (isSetOrgCooperationContract());
      list.add(present_orgCooperationContract);
      if (present_orgCooperationContract)
        list.add(orgCooperationContract);
    ...
    public int compareTo(getAll_args other) {
      ...
      lastComparison = Boolean.valueOf(isSetOrgCooperationContract()).compareTo(other.isSetOrgCooperationContract());
      if (lastComparison != 0) {
        return lastComparison;
      }
      if (isSetOrgCooperationContract()) {
        lastComparison = org.apache.thrift.TBaseHelper.compareTo(this.orgCooperationContract, other.orgCooperationContract);
        if (lastComparison != 0) {
          return lastComparison;
        }
      }
    ...
    public String toString() {
      ...
      sb.append("orgCooperationContract:");
      if (this.orgCooperationContract == null) {
        sb.append("null");
      } else {
        sb.append(this.orgCooperationContract);
      }
      first = false;
      sb.append(")");
      return sb.toString();
    ...
    public void validate() throws org.apache.thrift.TException {
      ...
      if (orgCooperationContract != null) {
        orgCooperationContract.validate();
      }
    }
    ...
    private static class getAll_argsStandardScheme extends StandardScheme<getAll_args> {
          ...
          switch (schemeField.id) {
            case 1: // ORG_COOPERATION_CONTRACT
              if (schemeField.type == org.apache.thrift.protocol.TType.STRUCT) {
                struct.orgCooperationContract = new OrgCooperationContract();
                struct.orgCooperationContract.read(iprot);
                struct.setOrgCooperationContractIsSet(true);
              } else { 
      ...
      public void write(org.apache.thrift.protocol.TProtocol oprot, getAll_args struct) throws org.apache.thrift.TException {
        ...
        if (struct.orgCooperationContract != null) {
          oprot.writeFieldBegin(ORG_COOPERATION_CONTRACT_FIELD_DESC);
          struct.orgCooperationContract.write(oprot);
          oprot.writeFieldEnd();
        }
    ...
    private static class getAll_argsTupleScheme extends TupleScheme<getAll_args> {
      ...
      public void write(org.apache.thrift.protocol.TProtocol prot, getAll_args struct) throws org.apache.thrift.TException {
        ...
        if (struct.isSetOrgCooperationContract()) {
          optionals.set(0);
        }
  ...
  public static class getAll_result implements org.apache.thrift.TBase<getAll_result, getAll_result._Fields>, java.io.Serializable, Cloneable, Comparable<getAll_result>   {
    ...
    public List<OrgCooperationContract> success; // required
    ...
    public getAll_result(
      List<OrgCooperationContract> success)
    {
      this();
    ...
    public getAll_result(getAll_result other) {
      if (other.isSetSuccess()) {
        List<OrgCooperationContract> __this__success = new ArrayList<OrgCooperationContract>(other.success.size());
        for (OrgCooperationContract other_element : other.success) {
          __this__success.add(new OrgCooperationContract(other_element));
        }
    ...
    public java.util.Iterator<OrgCooperationContract> getSuccessIterator() {
      return (this.success == null) ? null : this.success.iterator();
    }

    public void addToSuccess(OrgCooperationContract elem) {
      if (this.success == null) {
        this.success = new ArrayList<OrgCooperationContract>();
      }
      this.success.add(elem);
    }

    public List<OrgCooperationContract> getSuccess() {
      return this.success;
    }

    public getAll_result setSuccess(List<OrgCooperationContract> success) {
      this.success = success;
      return this;
    }
    ...
    public void setFieldValue(_Fields field, Object value) {
      ...
      case SUCCESS:
        if (value == null) {
          ...
          setSuccess((List<OrgCooperationContract>)value);
        }
        break;
              ...
              if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
                {
                  ...
                  struct.success = new ArrayList<OrgCooperationContract>(_list152.size);
                  OrgCooperationContract _elem153;
                  for (int _i154 = 0; _i154 < _list152.size; ++_i154)
                  {
                    _elem153 = new OrgCooperationContract();
                    _elem153.read(iprot);
      ...
      public void write(org.apache.thrift.protocol.TProtocol oprot, getAll_result struct) throws org.apache.thrift.TException {
        ...
        if (struct.success != null) {
          oprot.writeFieldBegin(SUCCESS_FIELD_DESC);
          {
            ...
            for (OrgCooperationContract _iter155 : struct.success)
            {
        ...
        if (struct.isSetSuccess()) {
          {
            ...
            for (OrgCooperationContract _iter156 : struct.success)
            {
        ...
        if (incoming.get(0)) {
          {
            ...
            struct.success = new ArrayList<OrgCooperationContract>(_list157.size);
            OrgCooperationContract _elem158;
            for (int _i159 = 0; _i159 < _list157.size; ++_i159)
            {
              _elem158 = new OrgCooperationContract();
              _elem158.read(iprot);
  ...
  public static class getById_result implements org.apache.thrift.TBase<getById_result, getById_result._Fields>, java.io.Serializable, Cloneable, Comparable<getById_result>   {
    ...
    public OrgCooperationContract success; // required
    ...
    public getById_result(
      OrgCooperationContract success)
    {
      this();
      this.success = success;
    }
    ...
    public getById_result(getById_result other) {
      if (other.isSetSuccess()) {
        this.success = new OrgCooperationContract(other.success);
      }
    }
    ...
    public OrgCooperationContract getSuccess() {
      return this.success;
    }

    public getById_result setSuccess(OrgCooperationContract success) {
      this.success = success;
      return this;
    }
    ...
    public void setFieldValue(_Fields field, Object value) {
      ...
      case SUCCESS:
        if (value == null) {
          ...
          setSuccess((OrgCooperationContract)value);
        }
        break;
      ...
      public void read(org.apache.thrift.protocol.TProtocol iprot, getById_result struct) throws org.apache.thrift.TException {
        ...
        while (true)
        {
          ...
          switch (schemeField.id) {
            case 0: // SUCCESS
              if (schemeField.type == org.apache.thrift.protocol.TType.STRUCT) {
                struct.success = new OrgCooperationContract();
  ...
  public static class getByOrgIdAndType_args implements org.apache.thrift.TBase<getByOrgIdAndType_args, getByOrgIdAndType_args._Fields>, java.io.Serializable, Cloneable, Comparable<getByOrgIdAndType_args>   {
    private static final org.apache.thrift.protocol.TStruct STRUCT_DESC = new org.apache.thrift.protocol.TStruct("getByOrgIdAndType_args");
    ...
    private static final org.apache.thrift.protocol.TField CONTRACT_TYPE_FIELD_DESC = new org.apache.thrift.protocol.TField("contractType", org.apache.thrift.protocol.TType.I32, (short)2);

    private static final Map<Class<? extends IScheme>, SchemeFactory> schemes = new HashMap<Class<? extends IScheme>, SchemeFactory>();
    static {
      schemes.put(StandardScheme.class, new getByOrgIdAndType_argsStandardSchemeFactory());
      schemes.put(TupleScheme.class, new getByOrgIdAndType_argsTupleSchemeFactory());
    }
    ...
    public enum _Fields implements org.apache.thrift.TFieldIdEnum {
      ...
      CONTRACT_TYPE((short)2, "contractType");
    ...
    private static final int __CONTRACTTYPE_ISSET_ID = 1;
    private byte __isset_bitfield = 0;
    public static final Map<_Fields, org.apache.thrift.meta_data.FieldMetaData> metaDataMap;
    static {
      Map<_Fields, org.apache.thrift.meta_data.FieldMetaData> tmpMap = new EnumMap<_Fields, org.apache.thrift.meta_data.FieldMetaData>(_Fields.class);
      ...
      tmpMap.put(_Fields.CONTRACT_TYPE, new org.apache.thrift.meta_data.FieldMetaData("contractType", org.apache.thrift.TFieldRequirementType.DEFAULT, 
          new org.apache.thrift.meta_data.FieldValueMetaData(org.apache.thrift.protocol.TType.I32)));
      metaDataMap = Collections.unmodifiableMap(tmpMap);
      org.apache.thrift.meta_data.FieldMetaData.addStructMetaDataMap(getByOrgIdAndType_args.class, metaDataMap);
    }

    public getByOrgIdAndType_args() {
    }
     ...
     * Performs a deep copy on <i>other</i>.
     */
    public getByOrgIdAndType_args(getByOrgIdAndType_args other) {
      __isset_bitfield = other.__isset_bitfield;
      this.orgId = other.orgId;
      this.contractType = other.contractType;
    }

    public getByOrgIdAndType_args deepCopy() {
      return new getByOrgIdAndType_args(this);
    }
    ...
    public getByOrgIdAndType_args setOrgId(int orgId) {
      this.orgId = orgId;
      setOrgIdIsSet(true);
      return this;
    }
    ...
    public getByOrgIdAndType_args setContractType(int contractType) {
      this.contractType = contractType;
      setContractTypeIsSet(true);
      return this;
    }
    ...
    public boolean equals(Object that) {
      if (that == null)
        return false;
      if (that instanceof getByOrgIdAndType_args)
        return this.equals((getByOrgIdAndType_args)that);
      return false;
    }

    public boolean equals(getByOrgIdAndType_args that) {
      if (that == null)
        return false;
    ...
    @Override
    public int compareTo(getByOrgIdAndType_args other) {
      if (!getClass().equals(other.getClass())) {
        return getClass().getName().compareTo(other.getClass().getName());
      }
    ...
    @Override
    public String toString() {
      StringBuilder sb = new StringBuilder("getByOrgIdAndType_args(");
      boolean first = true;
    ...
    private static class getByOrgIdAndType_argsStandardSchemeFactory implements SchemeFactory {
      public getByOrgIdAndType_argsStandardScheme getScheme() {
        return new getByOrgIdAndType_argsStandardScheme();
      }
    }

    private static class getByOrgIdAndType_argsStandardScheme extends StandardScheme<getByOrgIdAndType_args> {

      public void read(org.apache.thrift.protocol.TProtocol iprot, getByOrgIdAndType_args struct) throws org.apache.thrift.TException {
        org.apache.thrift.protocol.TField schemeField;
        iprot.readStructBegin();
        while (true)
        {
      ...
      public void write(org.apache.thrift.protocol.TProtocol oprot, getByOrgIdAndType_args struct) throws org.apache.thrift.TException {
        struct.validate();
    ...
    private static class getByOrgIdAndType_argsTupleSchemeFactory implements SchemeFactory {
      public getByOrgIdAndType_argsTupleScheme getScheme() {
        return new getByOrgIdAndType_argsTupleScheme();
      }
    }

    private static class getByOrgIdAndType_argsTupleScheme extends TupleScheme<getByOrgIdAndType_args> {

      @Override
      public void write(org.apache.thrift.protocol.TProtocol prot, getByOrgIdAndType_args struct) throws org.apache.thrift.TException {
        TTupleProtocol oprot = (TTupleProtocol) prot;
        BitSet optionals = new BitSet();
      ...
      @Override
      public void read(org.apache.thrift.protocol.TProtocol prot, getByOrgIdAndType_args struct) throws org.apache.thrift.TException {
        TTupleProtocol iprot = (TTupleProtocol) prot;
  ...
  public static class getByOrgIdAndType_result implements org.apache.thrift.TBase<getByOrgIdAndType_result, getByOrgIdAndType_result._Fields>, java.io.Serializable, Cloneable, Comparable<getByOrgIdAndType_result>   {
    private static final org.apache.thrift.protocol.TStruct STRUCT_DESC = new org.apache.thrift.protocol.TStruct("getByOrgIdAndType_result");

    private static final org.apache.thrift.protocol.TField SUCCESS_FIELD_DESC = new org.apache.thrift.protocol.TField("success", org.apache.thrift.protocol.TType.STRUCT, (short)0);

    private static final Map<Class<? extends IScheme>, SchemeFactory> schemes = new HashMap<Class<? extends IScheme>, SchemeFactory>();
    static {
      schemes.put(StandardScheme.class, new getByOrgIdAndType_resultStandardSchemeFactory());
      schemes.put(TupleScheme.class, new getByOrgIdAndType_resultTupleSchemeFactory());
    }
    ...
    static {
      ...
      tmpMap.put(_Fields.SUCCESS, new org.apache.thrift.meta_data.FieldMetaData("success", org.apache.thrift.TFieldRequirementType.DEFAULT, 
          new org.apache.thrift.meta_data.StructMetaData(org.apache.thrift.protocol.TType.STRUCT, OrgCooperationContract.class)));
      metaDataMap = Collections.unmodifiableMap(tmpMap);
      org.apache.thrift.meta_data.FieldMetaData.addStructMetaDataMap(getByOrgIdAndType_result.class, metaDataMap);
    }

    public getByOrgIdAndType_result() {
    }
     ...
     * Performs a deep copy on <i>other</i>.
     */
    public getByOrgIdAndType_result(getByOrgIdAndType_result other) {
      if (other.isSetSuccess()) {
        this.success = new OrgCooperationContract(other.success);
      }
    }

    public getByOrgIdAndType_result deepCopy() {
      return new getByOrgIdAndType_result(this);
    }
    ...
    public getByOrgIdAndType_result setSuccess(OrgCooperationContract success) {
      this.success = success;
      return this;
    }
    ...
    public boolean equals(Object that) {
      if (that == null)
        return false;
      if (that instanceof getByOrgIdAndType_result)
        return this.equals((getByOrgIdAndType_result)that);
      return false;
    }

    public boolean equals(getByOrgIdAndType_result that) {
      if (that == null)
        return false;
    ...
    @Override
    public int compareTo(getByOrgIdAndType_result other) {
      if (!getClass().equals(other.getClass())) {
        return getClass().getName().compareTo(other.getClass().getName());
      }
    ...
    @Override
    public String toString() {
      StringBuilder sb = new StringBuilder("getByOrgIdAndType_result(");
      boolean first = true;
    ...
    private static class getByOrgIdAndType_resultStandardSchemeFactory implements SchemeFactory {
      public getByOrgIdAndType_resultStandardScheme getScheme() {
        return new getByOrgIdAndType_resultStandardScheme();
      }
    }

    private static class getByOrgIdAndType_resultStandardScheme extends StandardScheme<getByOrgIdAndType_result> {

      public void read(org.apache.thrift.protocol.TProtocol iprot, getByOrgIdAndType_result struct) throws org.apache.thrift.TException {
        org.apache.thrift.protocol.TField schemeField;
        iprot.readStructBegin();
        while (true)
        {
      ...
      public void write(org.apache.thrift.protocol.TProtocol oprot, getByOrgIdAndType_result struct) throws org.apache.thrift.TException {
        struct.validate();
    ...
    private static class getByOrgIdAndType_resultTupleSchemeFactory implements SchemeFactory {
      public getByOrgIdAndType_resultTupleScheme getScheme() {
        return new getByOrgIdAndType_resultTupleScheme();
      }
    }

    private static class getByOrgIdAndType_resultTupleScheme extends TupleScheme<getByOrgIdAndType_result> {

      @Override
      public void write(org.apache.thrift.protocol.TProtocol prot, getByOrgIdAndType_result struct) throws org.apache.thrift.TException {
        TTupleProtocol oprot = (TTupleProtocol) prot;
        BitSet optionals = new BitSet();
        if (struct.isSetSuccess()) {
          optionals.set(0);
      ...
      @Override
      public void read(org.apache.thrift.protocol.TProtocol prot, getByOrgIdAndType_result struct) throws org.apache.thrift.TException {
        TTupleProtocol iprot = (TTupleProtocol) prot;
        BitSet incoming = iprot.readBitSet(1);
        if (incoming.get(0)) {
          struct.success = new OrgCooperationContract();
  ...
  public static class insert_args implements org.apache.thrift.TBase<insert_args, insert_args._Fields>, java.io.Serializable, Cloneable, Comparable<insert_args>   {
    ...
    public insert_args setOrgCooperationContract(OrgCooperationContract orgCooperationContract) {
      this.orgCooperationContract = orgCooperationContract;
      return this;
    }
  ...
  public static class update_args implements org.apache.thrift.TBase<update_args, update_args._Fields>, java.io.Serializable, Cloneable, Comparable<update_args>   {
    ...
    public update_args setOrgCooperationContract(OrgCooperationContract orgCooperationContract) {
      this.orgCooperationContract = orgCooperationContract;
      return this;
    }
              ...
              if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
                {
                  ...
                  struct.pids = new ArrayList<Integer>(_list160.size);
                  int _elem161;
                  for (int _i162 = 0; _i162 < _list160.size; ++_i162)
                  {
                    _elem161 = iprot.readI32();
                    struct.pids.add(_elem161);
                  }
                  iprot.readListEnd();
                }
        ...
        if (incoming.get(0)) {
          {
            ...
            struct.pids = new ArrayList<Integer>(_list165.size);
            int _elem166;
            for (int _i167 = 0; _i167 < _list165.size; ++_i167)
            {
              _elem166 = iprot.readI32();
              struct.pids.add(_elem166);
            }
          }
          struct.setPidsIsSet(true);
        }
