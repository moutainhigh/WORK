...
public class OrgUserMenuInfo implements org.apache.thrift.TBase<OrgUserMenuInfo, OrgUserMenuInfo._Fields>, java.io.Serializable, Cloneable, Comparable<OrgUserMenuInfo> {
  private static final org.apache.thrift.protocol.TStruct STRUCT_DESC = new org.apache.thrift.protocol.TStruct("OrgUserMenuInfo");
  ...
  private static final org.apache.thrift.protocol.TField MENU_ID_FIELD_DESC = new org.apache.thrift.protocol.TField("menuId", org.apache.thrift.protocol.TType.I32, (short)4);

  private static final Map<Class<? extends IScheme>, SchemeFactory> schemes = new HashMap<Class<? extends IScheme>, SchemeFactory>();
  static {
    schemes.put(StandardScheme.class, new OrgUserMenuInfoStandardSchemeFactory());
    schemes.put(TupleScheme.class, new OrgUserMenuInfoTupleSchemeFactory());
  }
  ...
  static {
    ...
    org.apache.thrift.meta_data.FieldMetaData.addStructMetaDataMap(OrgUserMenuInfo.class, metaDataMap);
  }

  public OrgUserMenuInfo() {
  }
   ...
   */
  public OrgUserMenuInfo(OrgUserMenuInfo other) {
  ...
  public OrgUserMenuInfo deepCopy() {
    return new OrgUserMenuInfo(this);
  }
  ...
  public OrgUserMenuInfo setPid(int pid) {
    this.pid = pid;
    setPidIsSet(true);
    return this;
  }
  ...
  public OrgUserMenuInfo setUserId(int userId) {
    this.userId = userId;
    setUserIdIsSet(true);
    return this;
  }
  ...
  public OrgUserMenuInfo setOrgId(int orgId) {
    this.orgId = orgId;
    setOrgIdIsSet(true);
    return this;
  }
  ...
  public OrgUserMenuInfo setMenuId(int menuId) {
    this.menuId = menuId;
    setMenuIdIsSet(true);
    return this;
  }
  ...
  public boolean equals(Object that) {
    if (that == null)
      return false;
    if (that instanceof OrgUserMenuInfo)
      return this.equals((OrgUserMenuInfo)that);
    return false;
  }

  public boolean equals(OrgUserMenuInfo that) {
    if (that == null)
      return false;
  ...
  @Override
  public int compareTo(OrgUserMenuInfo other) {
  ...
  public String toString() {
    StringBuilder sb = new StringBuilder("OrgUserMenuInfo(");
    boolean first = true;
  ...
  private static class OrgUserMenuInfoStandardSchemeFactory implements SchemeFactory {
    public OrgUserMenuInfoStandardScheme getScheme() {
      return new OrgUserMenuInfoStandardScheme();
    }
  }

  private static class OrgUserMenuInfoStandardScheme extends StandardScheme<OrgUserMenuInfo> {

    public void read(org.apache.thrift.protocol.TProtocol iprot, OrgUserMenuInfo struct) throws org.apache.thrift.TException {
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, OrgUserMenuInfo struct) throws org.apache.thrift.TException {
      struct.validate();
  ...
  private static class OrgUserMenuInfoTupleSchemeFactory implements SchemeFactory {
    public OrgUserMenuInfoTupleScheme getScheme() {
      return new OrgUserMenuInfoTupleScheme();
    }
  }

  private static class OrgUserMenuInfoTupleScheme extends TupleScheme<OrgUserMenuInfo> {

    @Override
    public void write(org.apache.thrift.protocol.TProtocol prot, OrgUserMenuInfo struct) throws org.apache.thrift.TException {
    ...
    @Override
    public void read(org.apache.thrift.protocol.TProtocol prot, OrgUserMenuInfo struct) throws org.apache.thrift.TException {
