...
public class OrgUserMenuInfoService {

  public interface Iface {

    public List<OrgUserMenuInfo> getAll(OrgUserMenuInfo orgUserMenuInfo) throws org.apache.thrift.TException;

    public OrgUserMenuInfo getById(int pid) throws org.apache.thrift.TException;

    public int insert(OrgUserMenuInfo orgUserMenuInfo) throws org.apache.thrift.TException;

    public int update(OrgUserMenuInfo orgUserMenuInfo) throws org.apache.thrift.TException;
  ...
  public interface AsyncIface {
    ...
    public void getAll(OrgUserMenuInfo orgUserMenuInfo, org.apache.thrift.async.AsyncMethodCallback resultHandler) throws org.apache.thrift.TException;
    ...
    public void insert(OrgUserMenuInfo orgUserMenuInfo, org.apache.thrift.async.AsyncMethodCallback resultHandler) throws org.apache.thrift.TException;

    public void update(OrgUserMenuInfo orgUserMenuInfo, org.apache.thrift.async.AsyncMethodCallback resultHandler) throws org.apache.thrift.TException;
  ...
  public static class Client extends org.apache.thrift.TServiceClient implements Iface {
    ...
    public List<OrgUserMenuInfo> getAll(OrgUserMenuInfo orgUserMenuInfo) throws org.apache.thrift.TException
    {
      send_getAll(orgUserMenuInfo);
      return recv_getAll();
    }

    public void send_getAll(OrgUserMenuInfo orgUserMenuInfo) throws org.apache.thrift.TException
    {
      getAll_args args = new getAll_args();
      args.setOrgUserMenuInfo(orgUserMenuInfo);
      sendBase("getAll", args);
    }

    public List<OrgUserMenuInfo> recv_getAll() throws org.apache.thrift.TException
    {
    ...
    public OrgUserMenuInfo recv_getById() throws org.apache.thrift.TException
    {
    ...
    public int insert(OrgUserMenuInfo orgUserMenuInfo) throws org.apache.thrift.TException
    {
      send_insert(orgUserMenuInfo);
      return recv_insert();
    }

    public void send_insert(OrgUserMenuInfo orgUserMenuInfo) throws org.apache.thrift.TException
    {
    ...
    public int update(OrgUserMenuInfo orgUserMenuInfo) throws org.apache.thrift.TException
    {
      send_update(orgUserMenuInfo);
      return recv_update();
    }

    public void send_update(OrgUserMenuInfo orgUserMenuInfo) throws org.apache.thrift.TException
    {
  ...
  public static class AsyncClient extends org.apache.thrift.async.TAsyncClient implements AsyncIface {
    ...
    public void getAll(OrgUserMenuInfo orgUserMenuInfo, org.apache.thrift.async.AsyncMethodCallback resultHandler) throws org.apache.thrift.TException {
      checkReady();
      getAll_call method_call = new getAll_call(orgUserMenuInfo, resultHandler, this, ___protocolFactory, ___transport);
      this.___currentMethod = method_call;
      ___manager.call(method_call);
    }

    public static class getAll_call extends org.apache.thrift.async.TAsyncMethodCall {
      private OrgUserMenuInfo orgUserMenuInfo;
      public getAll_call(OrgUserMenuInfo orgUserMenuInfo, org.apache.thrift.async.AsyncMethodCallback resultHandler, org.apache.thrift.async.TAsyncClient client, org.apache.thrift.protocol.TProtocolFactory protocolFactory, org.apache.thrift.transport.TNonblockingTransport transport) throws org.apache.thrift.TException {
        super(client, protocolFactory, transport, resultHandler, false);
        this.orgUserMenuInfo = orgUserMenuInfo;
      }
      ...
      public List<OrgUserMenuInfo> getResult() throws org.apache.thrift.TException {
    ...
    public static class getById_call extends org.apache.thrift.async.TAsyncMethodCall {
      ...
      public OrgUserMenuInfo getResult() throws org.apache.thrift.TException {
        if (getState() != org.apache.thrift.async.TAsyncMethodCall.State.RESPONSE_READ) {
          throw new IllegalStateException("Method call not finished!");
        }
        org.apache.thrift.transport.TMemoryInputTransport memoryTransport = new org.apache.thrift.transport.TMemoryInputTransport(getFrameBuffer().array());
    ...
    public void insert(OrgUserMenuInfo orgUserMenuInfo, org.apache.thrift.async.AsyncMethodCallback resultHandler) throws org.apache.thrift.TException {
      checkReady();
      insert_call method_call = new insert_call(orgUserMenuInfo, resultHandler, this, ___protocolFactory, ___transport);
      this.___currentMethod = method_call;
      ___manager.call(method_call);
    }
    ...
    public static class insert_call extends org.apache.thrift.async.TAsyncMethodCall {
      private OrgUserMenuInfo orgUserMenuInfo;
      public insert_call(OrgUserMenuInfo orgUserMenuInfo, org.apache.thrift.async.AsyncMethodCallback resultHandler, org.apache.thrift.async.TAsyncClient client, org.apache.thrift.protocol.TProtocolFactory protocolFactory, org.apache.thrift.transport.TNonblockingTransport transport) throws org.apache.thrift.TException {
        super(client, protocolFactory, transport, resultHandler, false);
        this.orgUserMenuInfo = orgUserMenuInfo;
      }
    ...
    public void update(OrgUserMenuInfo orgUserMenuInfo, org.apache.thrift.async.AsyncMethodCallback resultHandler) throws org.apache.thrift.TException {
      checkReady();
      update_call method_call = new update_call(orgUserMenuInfo, resultHandler, this, ___protocolFactory, ___transport);
      this.___currentMethod = method_call;
      ___manager.call(method_call);
    }
    ...
    public static class update_call extends org.apache.thrift.async.TAsyncMethodCall {
      private OrgUserMenuInfo orgUserMenuInfo;
      public update_call(OrgUserMenuInfo orgUserMenuInfo, org.apache.thrift.async.AsyncMethodCallback resultHandler, org.apache.thrift.async.TAsyncClient client, org.apache.thrift.protocol.TProtocolFactory protocolFactory, org.apache.thrift.transport.TNonblockingTransport transport) throws org.apache.thrift.TException {
        super(client, protocolFactory, transport, resultHandler, false);
        this.orgUserMenuInfo = orgUserMenuInfo;
      }
  ...
  public static class Processor<I extends Iface> extends org.apache.thrift.TBaseProcessor<I> implements org.apache.thrift.TProcessor {
    ...
    public static class getAll<I extends Iface> extends org.apache.thrift.ProcessFunction<I, getAll_args> {
      ...
      public getAll_result getResult(I iface, getAll_args args) throws org.apache.thrift.TException {
        getAll_result result = new getAll_result();
        result.success = iface.getAll(args.orgUserMenuInfo);
        return result;
      }
    }
    ...
    public static class insert<I extends Iface> extends org.apache.thrift.ProcessFunction<I, insert_args> {
      ...
      public insert_result getResult(I iface, insert_args args) throws org.apache.thrift.TException {
        insert_result result = new insert_result();
        result.success = iface.insert(args.orgUserMenuInfo);
    ...
    public static class update<I extends Iface> extends org.apache.thrift.ProcessFunction<I, update_args> {
      ...
      public update_result getResult(I iface, update_args args) throws org.apache.thrift.TException {
        update_result result = new update_result();
        result.success = iface.update(args.orgUserMenuInfo);
        result.setSuccessIsSet(true);
        return result;
      }
    }
  ...
  public static class AsyncProcessor<I extends AsyncIface> extends org.apache.thrift.TBaseAsyncProcessor<I> {
    ...
    public static class getAll<I extends AsyncIface> extends org.apache.thrift.AsyncProcessFunction<I, getAll_args, List<OrgUserMenuInfo>> {
      public getAll() {
        super("getAll");
      }
      ...
      public AsyncMethodCallback<List<OrgUserMenuInfo>> getResultHandler(final AsyncFrameBuffer fb, final int seqid) {
        final org.apache.thrift.AsyncProcessFunction fcall = this;
        return new AsyncMethodCallback<List<OrgUserMenuInfo>>() { 
          public void onComplete(List<OrgUserMenuInfo> o) {
            getAll_result result = new getAll_result();
            result.success = o;
            try {
      ...
      public void start(I iface, getAll_args args, org.apache.thrift.async.AsyncMethodCallback<List<OrgUserMenuInfo>> resultHandler) throws TException {
        iface.getAll(args.orgUserMenuInfo,resultHandler);
      }
    }

    public static class getById<I extends AsyncIface> extends org.apache.thrift.AsyncProcessFunction<I, getById_args, OrgUserMenuInfo> {
      public getById() {
        super("getById");
      }
      ...
      public AsyncMethodCallback<OrgUserMenuInfo> getResultHandler(final AsyncFrameBuffer fb, final int seqid) {
        final org.apache.thrift.AsyncProcessFunction fcall = this;
        return new AsyncMethodCallback<OrgUserMenuInfo>() { 
          public void onComplete(OrgUserMenuInfo o) {
            getById_result result = new getById_result();
            result.success = o;
            try {
              fcall.sendResponse(fb,result, org.apache.thrift.protocol.TMessageType.REPLY,seqid);
      ...
      public void start(I iface, getById_args args, org.apache.thrift.async.AsyncMethodCallback<OrgUserMenuInfo> resultHandler) throws TException {
    ...
    public static class insert<I extends AsyncIface> extends org.apache.thrift.AsyncProcessFunction<I, insert_args, Integer> {
      ...
      public void start(I iface, insert_args args, org.apache.thrift.async.AsyncMethodCallback<Integer> resultHandler) throws TException {
        iface.insert(args.orgUserMenuInfo,resultHandler);
      }
    }
    ...
    public static class update<I extends AsyncIface> extends org.apache.thrift.AsyncProcessFunction<I, update_args, Integer> {
      ...
      public void start(I iface, update_args args, org.apache.thrift.async.AsyncMethodCallback<Integer> resultHandler) throws TException {
        iface.update(args.orgUserMenuInfo,resultHandler);
      }
    }
  ...
  public static class getAll_args implements org.apache.thrift.TBase<getAll_args, getAll_args._Fields>, java.io.Serializable, Cloneable, Comparable<getAll_args>   {
    ...
    private static final org.apache.thrift.protocol.TField ORG_USER_MENU_INFO_FIELD_DESC = new org.apache.thrift.protocol.TField("orgUserMenuInfo", org.apache.thrift.protocol.TType.STRUCT, (short)1);
    ...
    public OrgUserMenuInfo orgUserMenuInfo; // required

    /** The set of fields this struct contains, along with convenience methods for finding and manipulating them. */
    public enum _Fields implements org.apache.thrift.TFieldIdEnum {
      ORG_USER_MENU_INFO((short)1, "orgUserMenuInfo");
      ...
      public static _Fields findByThriftId(int fieldId) {
        switch(fieldId) {
          case 1: // ORG_USER_MENU_INFO
            return ORG_USER_MENU_INFO;
          default:
            return null;
        }
      }
    ...
    static {
      ...
      tmpMap.put(_Fields.ORG_USER_MENU_INFO, new org.apache.thrift.meta_data.FieldMetaData("orgUserMenuInfo", org.apache.thrift.TFieldRequirementType.DEFAULT, 
          new org.apache.thrift.meta_data.StructMetaData(org.apache.thrift.protocol.TType.STRUCT, OrgUserMenuInfo.class)));
    ...
    public getAll_args(
      OrgUserMenuInfo orgUserMenuInfo)
    {
      this();
      this.orgUserMenuInfo = orgUserMenuInfo;
    }
    ...
    public getAll_args(getAll_args other) {
      if (other.isSetOrgUserMenuInfo()) {
        this.orgUserMenuInfo = new OrgUserMenuInfo(other.orgUserMenuInfo);
      }
    }
    ...
    @Override
    public void clear() {
      this.orgUserMenuInfo = null;
    }

    public OrgUserMenuInfo getOrgUserMenuInfo() {
      return this.orgUserMenuInfo;
    }

    public getAll_args setOrgUserMenuInfo(OrgUserMenuInfo orgUserMenuInfo) {
      this.orgUserMenuInfo = orgUserMenuInfo;
      return this;
    }

    public void unsetOrgUserMenuInfo() {
      this.orgUserMenuInfo = null;
    }

    /** Returns true if field orgUserMenuInfo is set (has been assigned a value) and false otherwise */
    public boolean isSetOrgUserMenuInfo() {
      return this.orgUserMenuInfo != null;
    }

    public void setOrgUserMenuInfoIsSet(boolean value) {
      if (!value) {
        this.orgUserMenuInfo = null;
      }
    }
    ...
    public void setFieldValue(_Fields field, Object value) {
      switch (field) {
      case ORG_USER_MENU_INFO:
        if (value == null) {
          unsetOrgUserMenuInfo();
        } else {
          setOrgUserMenuInfo((OrgUserMenuInfo)value);
        }
        break;
    ...
    public boolean equals(getAll_args that) {
      ...
      boolean this_present_orgUserMenuInfo = true && this.isSetOrgUserMenuInfo();
      boolean that_present_orgUserMenuInfo = true && that.isSetOrgUserMenuInfo();
      if (this_present_orgUserMenuInfo || that_present_orgUserMenuInfo) {
        if (!(this_present_orgUserMenuInfo && that_present_orgUserMenuInfo))
          return false;
        if (!this.orgUserMenuInfo.equals(that.orgUserMenuInfo))
          return false;
      }
    ...
    public int hashCode() {
      ...
      boolean present_orgUserMenuInfo = true && (isSetOrgUserMenuInfo());
      list.add(present_orgUserMenuInfo);
      if (present_orgUserMenuInfo)
        list.add(orgUserMenuInfo);
    ...
    public int compareTo(getAll_args other) {
      ...
      lastComparison = Boolean.valueOf(isSetOrgUserMenuInfo()).compareTo(other.isSetOrgUserMenuInfo());
      if (lastComparison != 0) {
        return lastComparison;
      }
      if (isSetOrgUserMenuInfo()) {
        lastComparison = org.apache.thrift.TBaseHelper.compareTo(this.orgUserMenuInfo, other.orgUserMenuInfo);
        if (lastComparison != 0) {
          return lastComparison;
        }
      }
    ...
    public String toString() {
      ...
      sb.append("orgUserMenuInfo:");
      if (this.orgUserMenuInfo == null) {
        sb.append("null");
      } else {
        sb.append(this.orgUserMenuInfo);
      }
      first = false;
      sb.append(")");
      return sb.toString();
    ...
    private static class getAll_argsStandardScheme extends StandardScheme<getAll_args> {
          ...
          switch (schemeField.id) {
            case 1: // ORG_USER_MENU_INFO
              if (schemeField.type == org.apache.thrift.protocol.TType.STRUCT) {
                struct.orgUserMenuInfo = new OrgUserMenuInfo();
                struct.orgUserMenuInfo.read(iprot);
                struct.setOrgUserMenuInfoIsSet(true);
              } else { 
      ...
      public void write(org.apache.thrift.protocol.TProtocol oprot, getAll_args struct) throws org.apache.thrift.TException {
        ...
        if (struct.orgUserMenuInfo != null) {
          oprot.writeFieldBegin(ORG_USER_MENU_INFO_FIELD_DESC);
          struct.orgUserMenuInfo.write(oprot);
          oprot.writeFieldEnd();
        }
    ...
    private static class getAll_argsTupleScheme extends TupleScheme<getAll_args> {
      ...
      public void write(org.apache.thrift.protocol.TProtocol prot, getAll_args struct) throws org.apache.thrift.TException {
        ...
        if (struct.isSetOrgUserMenuInfo()) {
          optionals.set(0);
        }
  ...
  public static class getAll_result implements org.apache.thrift.TBase<getAll_result, getAll_result._Fields>, java.io.Serializable, Cloneable, Comparable<getAll_result>   {
    ...
    public List<OrgUserMenuInfo> success; // required
    ...
    public getAll_result(getAll_result other) {
      if (other.isSetSuccess()) {
        List<OrgUserMenuInfo> __this__success = new ArrayList<OrgUserMenuInfo>(other.success.size());
        for (OrgUserMenuInfo other_element : other.success) {
          __this__success.add(new OrgUserMenuInfo(other_element));
        }
    ...
    public java.util.Iterator<OrgUserMenuInfo> getSuccessIterator() {
      return (this.success == null) ? null : this.success.iterator();
    }

    public void addToSuccess(OrgUserMenuInfo elem) {
      if (this.success == null) {
        this.success = new ArrayList<OrgUserMenuInfo>();
      }
      this.success.add(elem);
    }

    public List<OrgUserMenuInfo> getSuccess() {
      return this.success;
    }

    public getAll_result setSuccess(List<OrgUserMenuInfo> success) {
      this.success = success;
      return this;
    }
    ...
    public void setFieldValue(_Fields field, Object value) {
      ...
      case SUCCESS:
        if (value == null) {
          ...
          setSuccess((List<OrgUserMenuInfo>)value);
        }
        break;
              ...
              if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
                {
                  ...
                  struct.success = new ArrayList<OrgUserMenuInfo>(_list96.size);
                  OrgUserMenuInfo _elem97;
                  for (int _i98 = 0; _i98 < _list96.size; ++_i98)
                  {
                    _elem97 = new OrgUserMenuInfo();
                    _elem97.read(iprot);
      ...
      public void write(org.apache.thrift.protocol.TProtocol oprot, getAll_result struct) throws org.apache.thrift.TException {
        ...
        if (struct.success != null) {
          oprot.writeFieldBegin(SUCCESS_FIELD_DESC);
          {
            ...
            for (OrgUserMenuInfo _iter99 : struct.success)
            {
              _iter99.write(oprot);
            }
            oprot.writeListEnd();
        ...
        if (struct.isSetSuccess()) {
          {
            ...
            for (OrgUserMenuInfo _iter100 : struct.success)
            {
        ...
        if (incoming.get(0)) {
          {
            ...
            struct.success = new ArrayList<OrgUserMenuInfo>(_list101.size);
            OrgUserMenuInfo _elem102;
            for (int _i103 = 0; _i103 < _list101.size; ++_i103)
            {
              _elem102 = new OrgUserMenuInfo();
              _elem102.read(iprot);
  ...
  public static class getById_result implements org.apache.thrift.TBase<getById_result, getById_result._Fields>, java.io.Serializable, Cloneable, Comparable<getById_result>   {
    ...
    public OrgUserMenuInfo success; // required
    ...
    public getById_result(getById_result other) {
      if (other.isSetSuccess()) {
        this.success = new OrgUserMenuInfo(other.success);
      }
    }
    ...
    public OrgUserMenuInfo getSuccess() {
      return this.success;
    }

    public getById_result setSuccess(OrgUserMenuInfo success) {
      this.success = success;
      return this;
    }
    ...
    public void setFieldValue(_Fields field, Object value) {
      ...
      case SUCCESS:
        if (value == null) {
          ...
          setSuccess((OrgUserMenuInfo)value);
        }
        break;
      ...
      public void read(org.apache.thrift.protocol.TProtocol iprot, getById_result struct) throws org.apache.thrift.TException {
        ...
        while (true)
        {
          ...
          switch (schemeField.id) {
            case 0: // SUCCESS
              if (schemeField.type == org.apache.thrift.protocol.TType.STRUCT) {
                struct.success = new OrgUserMenuInfo();
  ...
  public static class insert_args implements org.apache.thrift.TBase<insert_args, insert_args._Fields>, java.io.Serializable, Cloneable, Comparable<insert_args>   {
    ...
    public insert_args setOrgUserMenuInfo(OrgUserMenuInfo orgUserMenuInfo) {
      this.orgUserMenuInfo = orgUserMenuInfo;
      return this;
    }
  ...
  public static class update_args implements org.apache.thrift.TBase<update_args, update_args._Fields>, java.io.Serializable, Cloneable, Comparable<update_args>   {
    ...
    public update_args setOrgUserMenuInfo(OrgUserMenuInfo orgUserMenuInfo) {
      this.orgUserMenuInfo = orgUserMenuInfo;
      return this;
    }
              ...
              if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
                {
                  ...
                  struct.pids = new ArrayList<Integer>(_list104.size);
                  int _elem105;
                  for (int _i106 = 0; _i106 < _list104.size; ++_i106)
                  {
                    _elem105 = iprot.readI32();
                    struct.pids.add(_elem105);
                  }
                  iprot.readListEnd();
                }
        ...
        if (incoming.get(0)) {
          {
            ...
            struct.pids = new ArrayList<Integer>(_list109.size);
            int _elem110;
            for (int _i111 = 0; _i111 < _list109.size; ++_i111)
            {
              _elem110 = iprot.readI32();
              struct.pids.add(_elem110);
            }
          }
          struct.setPidsIsSet(true);
        }
