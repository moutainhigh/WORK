...
public class BizMeetingMinutesFile implements org.apache.thrift.TBase<BizMeetingMinutesFile, BizMeetingMinutesFile._Fields>, java.io.Serializable, Cloneable, Comparable<BizMeetingMinutesFile> {
  private static final org.apache.thrift.protocol.TStruct STRUCT_DESC = new org.apache.thrift.protocol.TStruct("BizMeetingMinutesFile");
  ...
  static {
    schemes.put(StandardScheme.class, new BizMeetingMinutesFileStandardSchemeFactory());
    schemes.put(TupleScheme.class, new BizMeetingMinutesFileTupleSchemeFactory());
  }
  ...
  static {
    ...
    org.apache.thrift.meta_data.FieldMetaData.addStructMetaDataMap(BizMeetingMinutesFile.class, metaDataMap);
  }

  public BizMeetingMinutesFile() {
  }
   ...
   */
  public BizMeetingMinutesFile(BizMeetingMinutesFile other) {
  ...
  public BizMeetingMinutesFile deepCopy() {
    return new BizMeetingMinutesFile(this);
  }
  ...
  public BizMeetingMinutesFile setPid(int pid) {
    this.pid = pid;
    setPidIsSet(true);
    return this;
  }
  ...
  public BizMeetingMinutesFile setMeetingId(int meetingId) {
    this.meetingId = meetingId;
    setMeetingIdIsSet(true);
    return this;
  }
  ...
  public BizMeetingMinutesFile setFileId(int fileId) {
    this.fileId = fileId;
    setFileIdIsSet(true);
    return this;
  }
  ...
  public BizMeetingMinutesFile setStatus(int status) {
    this.status = status;
    setStatusIsSet(true);
    return this;
  }
  ...
  public boolean equals(Object that) {
    if (that == null)
      return false;
    if (that instanceof BizMeetingMinutesFile)
      return this.equals((BizMeetingMinutesFile)that);
    return false;
  }

  public boolean equals(BizMeetingMinutesFile that) {
    if (that == null)
      return false;
  ...
  @Override
  public int compareTo(BizMeetingMinutesFile other) {
  ...
  public String toString() {
    StringBuilder sb = new StringBuilder("BizMeetingMinutesFile(");
    boolean first = true;
  ...
  private static class BizMeetingMinutesFileStandardSchemeFactory implements SchemeFactory {
    public BizMeetingMinutesFileStandardScheme getScheme() {
      return new BizMeetingMinutesFileStandardScheme();
    }
  }

  private static class BizMeetingMinutesFileStandardScheme extends StandardScheme<BizMeetingMinutesFile> {

    public void read(org.apache.thrift.protocol.TProtocol iprot, BizMeetingMinutesFile struct) throws org.apache.thrift.TException {
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, BizMeetingMinutesFile struct) throws org.apache.thrift.TException {
      struct.validate();
  ...
  private static class BizMeetingMinutesFileTupleSchemeFactory implements SchemeFactory {
    public BizMeetingMinutesFileTupleScheme getScheme() {
      return new BizMeetingMinutesFileTupleScheme();
    }
  }

  private static class BizMeetingMinutesFileTupleScheme extends TupleScheme<BizMeetingMinutesFile> {

    @Override
    public void write(org.apache.thrift.protocol.TProtocol prot, BizMeetingMinutesFile struct) throws org.apache.thrift.TException {
    ...
    @Override
    public void read(org.apache.thrift.protocol.TProtocol prot, BizMeetingMinutesFile struct) throws org.apache.thrift.TException {
