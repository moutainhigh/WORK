...
public class DataInfo implements org.apache.thrift.TBase<DataInfo, DataInfo._Fields>, java.io.Serializable, Cloneable, Comparable<DataInfo> {
  ...
  private static final org.apache.thrift.protocol.TField COLLECT_FILE_STATUS_FIELD_DESC = new org.apache.thrift.protocol.TField("collectFileStatus", org.apache.thrift.protocol.TType.I32, (short)17);
  private static final org.apache.thrift.protocol.TField PROJECT_TYPES_FIELD_DESC = new org.apache.thrift.protocol.TField("projectTypes", org.apache.thrift.protocol.TType.LIST, (short)18);
  private static final org.apache.thrift.protocol.TField CREATE_USER_NAME_FIELD_DESC = new org.apache.thrift.protocol.TField("createUserName", org.apache.thrift.protocol.TType.STRING, (short)19);
  private static final org.apache.thrift.protocol.TField CREATE_NODE_FIELD_DESC = new org.apache.thrift.protocol.TField("createNode", org.apache.thrift.protocol.TType.I32, (short)20);
  ...
  public List<String> projectTypes; // required
  ...
  public enum _Fields implements org.apache.thrift.TFieldIdEnum {
    ...
    PAGE((short)15, "page"),
    ROWS((short)16, "rows"),
    COLLECT_FILE_STATUS((short)17, "collectFileStatus"),
    PROJECT_TYPES((short)18, "projectTypes"),
    CREATE_USER_NAME((short)19, "createUserName"),
    CREATE_NODE((short)20, "createNode");
    ...
    public static _Fields findByThriftId(int fieldId) {
      switch(fieldId) {
        ...
        case 16: // ROWS
          return ROWS;
        case 17: // COLLECT_FILE_STATUS
          return COLLECT_FILE_STATUS;
        case 18: // PROJECT_TYPES
          return PROJECT_TYPES;
        case 19: // CREATE_USER_NAME
  ...
  private static final int __COLLECTFILESTATUS_ISSET_ID = 9;
  ...
  public DataInfo(DataInfo other) {
    ...
    if (other.isSetProjectTypes()) {
      List<String> __this__projectTypes = new ArrayList<String>(other.projectTypes);
      this.projectTypes = __this__projectTypes;
    }
  ...
  public DataInfo setDataId(int dataId) {
    this.dataId = dataId;
    setDataIdIsSet(true);
    return this;
  }
  ...
  public DataInfo setProjectId(int projectId) {
    this.projectId = projectId;
    setProjectIdIsSet(true);
    return this;
  }
  ...
  public DataInfo setFileId(int fileId) {
    this.fileId = fileId;
    setFileIdIsSet(true);
    return this;
  }
  ...
  public DataInfo setUserId(int userId) {
    this.userId = userId;
    setUserIdIsSet(true);
    return this;
  }
  ...
  public DataInfo setFileProperty(int fileProperty) {
    this.fileProperty = fileProperty;
    setFilePropertyIsSet(true);
    return this;
  }
  ...
  public DataInfo setFilePropertyName(String filePropertyName) {
    this.filePropertyName = filePropertyName;
    return this;
  }
  ...
  public DataInfo setFileDesc(String fileDesc) {
    this.fileDesc = fileDesc;
    return this;
  }
  ...
  public DataInfo setFileType(String fileType) {
    this.fileType = fileType;
    return this;
  }
  ...
  public DataInfo setFileSize(int fileSize) {
    this.fileSize = fileSize;
    setFileSizeIsSet(true);
    return this;
  }
  ...
  public DataInfo setFileUrl(String fileUrl) {
    this.fileUrl = fileUrl;
    return this;
  }
  ...
  public DataInfo setUploadDttm(String uploadDttm) {
    this.uploadDttm = uploadDttm;
    return this;
  }
  ...
  public DataInfo setCusType(String cusType) {
    this.cusType = cusType;
    return this;
  }
  ...
  public DataInfo setPage(int page) {
    this.page = page;
    setPageIsSet(true);
    return this;
  }
  ...
  public DataInfo setRows(int rows) {
    this.rows = rows;
    setRowsIsSet(true);
    return this;
  }
  ...
  public DataInfo setCollectFileStatus(int collectFileStatus) {
    this.collectFileStatus = collectFileStatus;
    setCollectFileStatusIsSet(true);
    return this;
  }
  ...
  public int getProjectTypesSize() {
    return (this.projectTypes == null) ? 0 : this.projectTypes.size();
  }

  public java.util.Iterator<String> getProjectTypesIterator() {
    return (this.projectTypes == null) ? null : this.projectTypes.iterator();
  }

  public void addToProjectTypes(String elem) {
    if (this.projectTypes == null) {
      this.projectTypes = new ArrayList<String>();
    }
    this.projectTypes.add(elem);
  }
  ...
  public DataInfo setProjectTypes(List<String> projectTypes) {
    this.projectTypes = projectTypes;
    return this;
  }
  ...
  public DataInfo setCreateUserName(String createUserName) {
    this.createUserName = createUserName;
    return this;
  }
  ...
  public DataInfo setCreateNode(int createNode) {
    this.createNode = createNode;
    setCreateNodeIsSet(true);
    return this;
  }
  ...
  public void setFieldValue(_Fields field, Object value) {
    ...
    case PROJECT_TYPES:
      if (value == null) {
        ...
        setProjectTypes((List<String>)value);
      }
      break;
  ...
  private static class DataInfoStandardScheme extends StandardScheme<DataInfo> {
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.projectTypes = new ArrayList<String>(_list48.size);
                String _elem49;
                for (int _i50 = 0; _i50 < _list48.size; ++_i50)
                {
                  _elem49 = iprot.readString();
                  struct.projectTypes.add(_elem49);
                }
                iprot.readListEnd();
              }
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, DataInfo struct) throws org.apache.thrift.TException {
      ...
      if (struct.projectTypes != null) {
        ...
        {
          oprot.writeListBegin(new org.apache.thrift.protocol.TList(org.apache.thrift.protocol.TType.STRING, struct.projectTypes.size()));
          for (String _iter51 : struct.projectTypes)
          {
  ...
  private static class DataInfoTupleScheme extends TupleScheme<DataInfo> {
    ...
    public void write(org.apache.thrift.protocol.TProtocol prot, DataInfo struct) throws org.apache.thrift.TException {
      ...
      if (struct.isSetProjectTypes()) {
        {
          oprot.writeI32(struct.projectTypes.size());
          for (String _iter52 : struct.projectTypes)
          {
      ...
      if (incoming.get(17)) {
        {
          ...
          struct.projectTypes = new ArrayList<String>(_list53.size);
          String _elem54;
          for (int _i55 = 0; _i55 < _list53.size; ++_i55)
          {
            _elem54 = iprot.readString();
            struct.projectTypes.add(_elem54);
          }
        }
        struct.setProjectTypesIsSet(true);
      }
