...
public class SysSmsInfo implements org.apache.thrift.TBase<SysSmsInfo, SysSmsInfo._Fields>, java.io.Serializable, Cloneable, Comparable<SysSmsInfo> {
  private static final org.apache.thrift.protocol.TStruct STRUCT_DESC = new org.apache.thrift.protocol.TStruct("SysSmsInfo");
  ...
  static {
    schemes.put(StandardScheme.class, new SysSmsInfoStandardSchemeFactory());
    schemes.put(TupleScheme.class, new SysSmsInfoTupleSchemeFactory());
  }
  ...
  static {
    ...
    org.apache.thrift.meta_data.FieldMetaData.addStructMetaDataMap(SysSmsInfo.class, metaDataMap);
  }
   ...
   */
  public SysSmsInfo(SysSmsInfo other) {
  ...
  public SysSmsInfo deepCopy() {
    return new SysSmsInfo(this);
  }
  ...
  public SysSmsInfo setPid(int pid) {
    this.pid = pid;
    setPidIsSet(true);
    return this;
  }
  ...
  public SysSmsInfo setTelphone(String telphone) {
    this.telphone = telphone;
    return this;
  }
  ...
  public SysSmsInfo setContent(String content) {
    this.content = content;
    return this;
  }
  ...
  public SysSmsInfo setSendDate(String sendDate) {
    this.sendDate = sendDate;
    return this;
  }
  ...
  public SysSmsInfo setCreateDate(String createDate) {
    this.createDate = createDate;
    return this;
  }
  ...
  public SysSmsInfo setCreatorId(int creatorId) {
    this.creatorId = creatorId;
    setCreatorIdIsSet(true);
    return this;
  }
  ...
  public SysSmsInfo setCategory(int category) {
    this.category = category;
    setCategoryIsSet(true);
    return this;
  }
  ...
  public SysSmsInfo setStatus(int status) {
    this.status = status;
    setStatusIsSet(true);
    return this;
  }
  ...
  public SysSmsInfo setIpAddress(String ipAddress) {
    this.ipAddress = ipAddress;
    return this;
  }
  ...
  public boolean equals(Object that) {
    if (that == null)
      return false;
    if (that instanceof SysSmsInfo)
      return this.equals((SysSmsInfo)that);
    return false;
  }

  public boolean equals(SysSmsInfo that) {
    if (that == null)
      return false;
  ...
  @Override
  public int compareTo(SysSmsInfo other) {
  ...
  public String toString() {
    StringBuilder sb = new StringBuilder("SysSmsInfo(");
    boolean first = true;
  ...
  private static class SysSmsInfoStandardSchemeFactory implements SchemeFactory {
    public SysSmsInfoStandardScheme getScheme() {
      return new SysSmsInfoStandardScheme();
    }
  }

  private static class SysSmsInfoStandardScheme extends StandardScheme<SysSmsInfo> {

    public void read(org.apache.thrift.protocol.TProtocol iprot, SysSmsInfo struct) throws org.apache.thrift.TException {
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, SysSmsInfo struct) throws org.apache.thrift.TException {
      struct.validate();
  ...
  private static class SysSmsInfoTupleSchemeFactory implements SchemeFactory {
    public SysSmsInfoTupleScheme getScheme() {
      return new SysSmsInfoTupleScheme();
    }
  }

  private static class SysSmsInfoTupleScheme extends TupleScheme<SysSmsInfo> {

    @Override
    public void write(org.apache.thrift.protocol.TProtocol prot, SysSmsInfo struct) throws org.apache.thrift.TException {
    ...
    @Override
    public void read(org.apache.thrift.protocol.TProtocol prot, SysSmsInfo struct) throws org.apache.thrift.TException {
