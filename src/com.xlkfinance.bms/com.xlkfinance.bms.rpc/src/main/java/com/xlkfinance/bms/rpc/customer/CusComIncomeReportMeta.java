...
public class CusComIncomeReportMeta implements org.apache.thrift.TBase<CusComIncomeReportMeta, CusComIncomeReportMeta._Fields>, java.io.Serializable, Cloneable, Comparable<CusComIncomeReportMeta> {
  private static final org.apache.thrift.protocol.TStruct STRUCT_DESC = new org.apache.thrift.protocol.TStruct("CusComIncomeReportMeta");
  ...
  private static final org.apache.thrift.protocol.TField ITEM_PREFIX_FIELD_DESC = new org.apache.thrift.protocol.TField("itemPrefix", org.apache.thrift.protocol.TType.STRING, (short)4);
  ...
  static {
    schemes.put(StandardScheme.class, new CusComIncomeReportMetaStandardSchemeFactory());
    schemes.put(TupleScheme.class, new CusComIncomeReportMetaTupleSchemeFactory());
  }
  ...
  public enum _Fields implements org.apache.thrift.TFieldIdEnum {
    ...
    ITEM_PREFIX((short)4, "itemPrefix"),
  ...
  private static final int __ISSUBTRACTION_ISSET_ID = 2;
  ...
  static {
    ...
    org.apache.thrift.meta_data.FieldMetaData.addStructMetaDataMap(CusComIncomeReportMeta.class, metaDataMap);
  }

  public CusComIncomeReportMeta() {
  }
   ...
   */
  public CusComIncomeReportMeta(CusComIncomeReportMeta other) {
  ...
  public CusComIncomeReportMeta deepCopy() {
    return new CusComIncomeReportMeta(this);
  }
  ...
  public CusComIncomeReportMeta setPid(int pid) {
    this.pid = pid;
    setPidIsSet(true);
    return this;
  }
  ...
  public CusComIncomeReportMeta setLineNum(int lineNum) {
    this.lineNum = lineNum;
    setLineNumIsSet(true);
    return this;
  }
  ...
  public CusComIncomeReportMeta setItemName(String itemName) {
    this.itemName = itemName;
    return this;
  }
  ...
  public CusComIncomeReportMeta setItemPrefix(String itemPrefix) {
    this.itemPrefix = itemPrefix;
    return this;
  }
  ...
  public CusComIncomeReportMeta setIsSubtraction(int isSubtraction) {
    this.isSubtraction = isSubtraction;
    setIsSubtractionIsSet(true);
    return this;
  }
  ...
  public CusComIncomeReportMeta setStatus(int status) {
    this.status = status;
    setStatusIsSet(true);
    return this;
  }
  ...
  public boolean equals(Object that) {
    if (that == null)
      return false;
    if (that instanceof CusComIncomeReportMeta)
      return this.equals((CusComIncomeReportMeta)that);
    return false;
  }

  public boolean equals(CusComIncomeReportMeta that) {
    if (that == null)
      return false;
  ...
  @Override
  public int compareTo(CusComIncomeReportMeta other) {
  ...
  public String toString() {
    StringBuilder sb = new StringBuilder("CusComIncomeReportMeta(");
    boolean first = true;
  ...
  private static class CusComIncomeReportMetaStandardSchemeFactory implements SchemeFactory {
    public CusComIncomeReportMetaStandardScheme getScheme() {
      return new CusComIncomeReportMetaStandardScheme();
    }
  }

  private static class CusComIncomeReportMetaStandardScheme extends StandardScheme<CusComIncomeReportMeta> {

    public void read(org.apache.thrift.protocol.TProtocol iprot, CusComIncomeReportMeta struct) throws org.apache.thrift.TException {
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, CusComIncomeReportMeta struct) throws org.apache.thrift.TException {
      struct.validate();
  ...
  private static class CusComIncomeReportMetaTupleSchemeFactory implements SchemeFactory {
    public CusComIncomeReportMetaTupleScheme getScheme() {
      return new CusComIncomeReportMetaTupleScheme();
    }
  }

  private static class CusComIncomeReportMetaTupleScheme extends TupleScheme<CusComIncomeReportMeta> {

    @Override
    public void write(org.apache.thrift.protocol.TProtocol prot, CusComIncomeReportMeta struct) throws org.apache.thrift.TException {
    ...
    @Override
    public void read(org.apache.thrift.protocol.TProtocol prot, CusComIncomeReportMeta struct) throws org.apache.thrift.TException {
