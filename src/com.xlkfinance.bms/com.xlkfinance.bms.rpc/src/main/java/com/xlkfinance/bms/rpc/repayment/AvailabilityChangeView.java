...
public class AvailabilityChangeView implements org.apache.thrift.TBase<AvailabilityChangeView, AvailabilityChangeView._Fields>, java.io.Serializable, Cloneable, Comparable<AvailabilityChangeView> {
  private static final org.apache.thrift.protocol.TStruct STRUCT_DESC = new org.apache.thrift.protocol.TStruct("AvailabilityChangeView");
  ...
  private static final org.apache.thrift.protocol.TField PM_USER_ID_FIELD_DESC = new org.apache.thrift.protocol.TField("pmUserId", org.apache.thrift.protocol.TType.STRING, (short)16);
  private static final org.apache.thrift.protocol.TField INTEREST_CHG_ID_FIELD_DESC = new org.apache.thrift.protocol.TField("interestChgId", org.apache.thrift.protocol.TType.I32, (short)17);

  private static final Map<Class<? extends IScheme>, SchemeFactory> schemes = new HashMap<Class<? extends IScheme>, SchemeFactory>();
  static {
    schemes.put(StandardScheme.class, new AvailabilityChangeViewStandardSchemeFactory());
    schemes.put(TupleScheme.class, new AvailabilityChangeViewTupleSchemeFactory());
  }
  ...
  public String pmUserId; // required
  ...
  public enum _Fields implements org.apache.thrift.TFieldIdEnum {
    ...
    INTEREST_CHG_ID((short)17, "interestChgId");
  ...
  static {
    ...
    org.apache.thrift.meta_data.FieldMetaData.addStructMetaDataMap(AvailabilityChangeView.class, metaDataMap);
  }

  public AvailabilityChangeView() {
  }
   ...
   */
  public AvailabilityChangeView(AvailabilityChangeView other) {
    ...
    if (other.isSetPmUserId()) {
      this.pmUserId = other.pmUserId;
    }
    this.interestChgId = other.interestChgId;
  }

  public AvailabilityChangeView deepCopy() {
    return new AvailabilityChangeView(this);
  }
  ...
  public AvailabilityChangeView setPId(String pId) {
    this.pId = pId;
    return this;
  }
  ...
  public AvailabilityChangeView setProjectId(String projectId) {
    this.projectId = projectId;
    return this;
  }
  ...
  public AvailabilityChangeView setProjectName(String projectName) {
    this.projectName = projectName;
    return this;
  }
  ...
  public AvailabilityChangeView setCusType(String cusType) {
    this.cusType = cusType;
    return this;
  }
  ...
  public AvailabilityChangeView setCreditAmt(double creditAmt) {
    this.creditAmt = creditAmt;
    setCreditAmtIsSet(true);
    return this;
  }
  ...
  public AvailabilityChangeView setRequestDttm(String requestDttm) {
    this.requestDttm = requestDttm;
    return this;
  }
  ...
  public AvailabilityChangeView setPlanRepayLoanDt(String planRepayLoanDt) {
    this.planRepayLoanDt = planRepayLoanDt;
    return this;
  }
  ...
  public AvailabilityChangeView setPmuserName(String pmuserName) {
    this.pmuserName = pmuserName;
    return this;
  }
  ...
  public AvailabilityChangeView setCusName(String cusName) {
    this.cusName = cusName;
    return this;
  }
  ...
  public AvailabilityChangeView setPlanRepayLoanDtLast(String planRepayLoanDtLast) {
    this.planRepayLoanDtLast = planRepayLoanDtLast;
    return this;
  }
  ...
  public AvailabilityChangeView setRequestDttmLast(String requestDttmLast) {
    this.requestDttmLast = requestDttmLast;
    return this;
  }
  ...
  public AvailabilityChangeView setEcoTrade(String ecoTrade) {
    this.ecoTrade = ecoTrade;
    return this;
  }
  ...
  public AvailabilityChangeView setPlanOutLoanDt(String planOutLoanDt) {
    this.planOutLoanDt = planOutLoanDt;
    return this;
  }
  ...
  public AvailabilityChangeView setPmUserId(String pmUserId) {
    this.pmUserId = pmUserId;
    return this;
  }
  ...
  public AvailabilityChangeView setInterestChgId(int interestChgId) {
    this.interestChgId = interestChgId;
    setInterestChgIdIsSet(true);
    return this;
  }
  ...
  public boolean equals(Object that) {
    if (that == null)
      return false;
    if (that instanceof AvailabilityChangeView)
      return this.equals((AvailabilityChangeView)that);
    return false;
  }

  public boolean equals(AvailabilityChangeView that) {
    if (that == null)
      return false;
    ...
    boolean this_present_pmUserId = true && this.isSetPmUserId();
    boolean that_present_pmUserId = true && that.isSetPmUserId();
    if (this_present_pmUserId || that_present_pmUserId) {
      if (!(this_present_pmUserId && that_present_pmUserId))
        return false;
      if (!this.pmUserId.equals(that.pmUserId))
        return false;
    }
  ...
  public int hashCode() {
    ...
    boolean present_pmUserId = true && (isSetPmUserId());
  ...
  @Override
  public int compareTo(AvailabilityChangeView other) {
  ...
  public String toString() {
    StringBuilder sb = new StringBuilder("AvailabilityChangeView(");
    boolean first = true;
  ...
  private static class AvailabilityChangeViewStandardSchemeFactory implements SchemeFactory {
    public AvailabilityChangeViewStandardScheme getScheme() {
      return new AvailabilityChangeViewStandardScheme();
    }
  }

  private static class AvailabilityChangeViewStandardScheme extends StandardScheme<AvailabilityChangeView> {

    public void read(org.apache.thrift.protocol.TProtocol iprot, AvailabilityChangeView struct) throws org.apache.thrift.TException {
      ...
      while (true)
      {
        ...
        switch (schemeField.id) {
          ...
          case 16: // PM_USER_ID
            if (schemeField.type == org.apache.thrift.protocol.TType.STRING) {
              struct.pmUserId = iprot.readString();
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, AvailabilityChangeView struct) throws org.apache.thrift.TException {
      struct.validate();
      ...
      if (struct.pmUserId != null) {
        oprot.writeFieldBegin(PM_USER_ID_FIELD_DESC);
        oprot.writeString(struct.pmUserId);
        oprot.writeFieldEnd();
      }
  ...
  private static class AvailabilityChangeViewTupleSchemeFactory implements SchemeFactory {
    public AvailabilityChangeViewTupleScheme getScheme() {
      return new AvailabilityChangeViewTupleScheme();
    }
  }

  private static class AvailabilityChangeViewTupleScheme extends TupleScheme<AvailabilityChangeView> {

    @Override
    public void write(org.apache.thrift.protocol.TProtocol prot, AvailabilityChangeView struct) throws org.apache.thrift.TException {
    ...
    @Override
    public void read(org.apache.thrift.protocol.TProtocol prot, AvailabilityChangeView struct) throws org.apache.thrift.TException {
