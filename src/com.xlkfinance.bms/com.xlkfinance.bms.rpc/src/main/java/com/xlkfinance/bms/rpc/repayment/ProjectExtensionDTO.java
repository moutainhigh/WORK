...
public class ProjectExtensionDTO implements org.apache.thrift.TBase<ProjectExtensionDTO, ProjectExtensionDTO._Fields>, java.io.Serializable, Cloneable, Comparable<ProjectExtensionDTO> {
  private static final org.apache.thrift.protocol.TStruct STRUCT_DESC = new org.apache.thrift.protocol.TStruct("ProjectExtensionDTO");
  ...
  private static final org.apache.thrift.protocol.TField EXTENSION_DAYS_FIELD_DESC = new org.apache.thrift.protocol.TField("extensionDays", org.apache.thrift.protocol.TType.I32, (short)9);

  private static final Map<Class<? extends IScheme>, SchemeFactory> schemes = new HashMap<Class<? extends IScheme>, SchemeFactory>();
  static {
    schemes.put(StandardScheme.class, new ProjectExtensionDTOStandardSchemeFactory());
    schemes.put(TupleScheme.class, new ProjectExtensionDTOTupleSchemeFactory());
  }
  ...
  public enum _Fields implements org.apache.thrift.TFieldIdEnum {
    ...
    EXTENSION_DAYS((short)9, "extensionDays");
  ...
  private static final int __EXTENSIONDAYS_ISSET_ID = 7;
  ...
  static {
    ...
    org.apache.thrift.meta_data.FieldMetaData.addStructMetaDataMap(ProjectExtensionDTO.class, metaDataMap);
  }

  public ProjectExtensionDTO() {
  }
   ...
   */
  public ProjectExtensionDTO(ProjectExtensionDTO other) {
  ...
  public ProjectExtensionDTO deepCopy() {
    return new ProjectExtensionDTO(this);
  }
  ...
  public ProjectExtensionDTO setPid(int pid) {
    this.pid = pid;
    setPidIsSet(true);
    return this;
  }
  ...
  public ProjectExtensionDTO setProjectId(int projectId) {
    this.projectId = projectId;
    setProjectIdIsSet(true);
    return this;
  }
  ...
  public ProjectExtensionDTO setSelectCycleNum(int selectCycleNum) {
    this.selectCycleNum = selectCycleNum;
    setSelectCycleNumIsSet(true);
    return this;
  }
  ...
  public ProjectExtensionDTO setExtensionAmt(double extensionAmt) {
    this.extensionAmt = extensionAmt;
    setExtensionAmtIsSet(true);
    return this;
  }
  ...
  public ProjectExtensionDTO setStatus(int status) {
    this.status = status;
    setStatusIsSet(true);
    return this;
  }
  ...
  public ProjectExtensionDTO setExtensionProjectId(int extensionProjectId) {
    this.extensionProjectId = extensionProjectId;
    setExtensionProjectIdIsSet(true);
    return this;
  }
  ...
  public ProjectExtensionDTO setExtensionFee(double extensionFee) {
    this.extensionFee = extensionFee;
    setExtensionFeeIsSet(true);
    return this;
  }
  ...
  public ProjectExtensionDTO setExtensionDate(String extensionDate) {
    this.extensionDate = extensionDate;
    return this;
  }
  ...
  public ProjectExtensionDTO setExtensionDays(int extensionDays) {
    this.extensionDays = extensionDays;
    setExtensionDaysIsSet(true);
    return this;
  }
  ...
  public boolean equals(Object that) {
    if (that == null)
      return false;
    if (that instanceof ProjectExtensionDTO)
      return this.equals((ProjectExtensionDTO)that);
    return false;
  }

  public boolean equals(ProjectExtensionDTO that) {
    if (that == null)
      return false;
  ...
  @Override
  public int compareTo(ProjectExtensionDTO other) {
  ...
  public String toString() {
    StringBuilder sb = new StringBuilder("ProjectExtensionDTO(");
    boolean first = true;
  ...
  private static class ProjectExtensionDTOStandardSchemeFactory implements SchemeFactory {
    public ProjectExtensionDTOStandardScheme getScheme() {
      return new ProjectExtensionDTOStandardScheme();
    }
  }

  private static class ProjectExtensionDTOStandardScheme extends StandardScheme<ProjectExtensionDTO> {

    public void read(org.apache.thrift.protocol.TProtocol iprot, ProjectExtensionDTO struct) throws org.apache.thrift.TException {
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, ProjectExtensionDTO struct) throws org.apache.thrift.TException {
      struct.validate();
  ...
  private static class ProjectExtensionDTOTupleSchemeFactory implements SchemeFactory {
    public ProjectExtensionDTOTupleScheme getScheme() {
      return new ProjectExtensionDTOTupleScheme();
    }
  }

  private static class ProjectExtensionDTOTupleScheme extends TupleScheme<ProjectExtensionDTO> {

    @Override
    public void write(org.apache.thrift.protocol.TProtocol prot, ProjectExtensionDTO struct) throws org.apache.thrift.TException {
    ...
    @Override
    public void read(org.apache.thrift.protocol.TProtocol prot, ProjectExtensionDTO struct) throws org.apache.thrift.TException {
