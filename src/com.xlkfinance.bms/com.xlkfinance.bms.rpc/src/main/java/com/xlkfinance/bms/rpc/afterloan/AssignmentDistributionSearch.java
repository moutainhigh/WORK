...
public class AssignmentDistributionSearch implements org.apache.thrift.TBase<AssignmentDistributionSearch, AssignmentDistributionSearch._Fields>, java.io.Serializable, Cloneable, Comparable<AssignmentDistributionSearch> {
  private static final org.apache.thrift.protocol.TStruct STRUCT_DESC = new org.apache.thrift.protocol.TStruct("AssignmentDistributionSearch");
  ...
  private static final org.apache.thrift.protocol.TField COLLECTION_USER_FIELD_DESC = new org.apache.thrift.protocol.TField("collectionUser", org.apache.thrift.protocol.TType.STRING, (short)13);
  ...
  private static final org.apache.thrift.protocol.TField RESULTS_FIELD_DESC = new org.apache.thrift.protocol.TField("results", org.apache.thrift.protocol.TType.LIST, (short)17);
  ...
  private static final org.apache.thrift.protocol.TField INDEX_START_FIELD_DESC = new org.apache.thrift.protocol.TField("indexStart", org.apache.thrift.protocol.TType.I32, (short)20);
  private static final org.apache.thrift.protocol.TField INDEX_END_FIELD_DESC = new org.apache.thrift.protocol.TField("indexEnd", org.apache.thrift.protocol.TType.I32, (short)21);

  private static final Map<Class<? extends IScheme>, SchemeFactory> schemes = new HashMap<Class<? extends IScheme>, SchemeFactory>();
  static {
    schemes.put(StandardScheme.class, new AssignmentDistributionSearchStandardSchemeFactory());
    schemes.put(TupleScheme.class, new AssignmentDistributionSearchTupleSchemeFactory());
  }
  ...
  public enum _Fields implements org.apache.thrift.TFieldIdEnum {
    ...
    COLLECTION_USER((short)13, "collectionUser"),
    ACCT_TYPE((short)14, "acctType"),
    PLAN_START_DT((short)15, "planStartDt"),
    PLAN_END_DT((short)16, "planEndDT"),
    RESULTS((short)17, "results"),
    ROWS((short)18, "rows"),
    PAGE((short)19, "page"),
    INDEX_START((short)20, "indexStart"),
    INDEX_END((short)21, "indexEnd");
  ...
  static {
    ...
    tmpMap.put(_Fields.REMINDER_STATUS, new org.apache.thrift.meta_data.FieldMetaData("reminderStatus", org.apache.thrift.TFieldRequirementType.DEFAULT, 
        new org.apache.thrift.meta_data.FieldValueMetaData(org.apache.thrift.protocol.TType.I32)));
    tmpMap.put(_Fields.COLLECTION_USER, new org.apache.thrift.meta_data.FieldMetaData("collectionUser", org.apache.thrift.TFieldRequirementType.DEFAULT, 
        new org.apache.thrift.meta_data.FieldValueMetaData(org.apache.thrift.protocol.TType.STRING)));
    ...
    org.apache.thrift.meta_data.FieldMetaData.addStructMetaDataMap(AssignmentDistributionSearch.class, metaDataMap);
  }

  public AssignmentDistributionSearch() {
  }
  ...
  public AssignmentDistributionSearch(
    ...
    String planStartDt,
    String planEndDT,
    List<AssignmentDistribution> results,
    int rows,
    int page,
    int indexStart,
    int indexEnd)
   ...
   */
  public AssignmentDistributionSearch(AssignmentDistributionSearch other) {
    ...
    if (other.isSetCollectionUser()) {
      this.collectionUser = other.collectionUser;
    }
    ...
    if (other.isSetResults()) {
      List<AssignmentDistribution> __this__results = new ArrayList<AssignmentDistribution>(other.results.size());
      for (AssignmentDistribution other_element : other.results) {
        __this__results.add(new AssignmentDistribution(other_element));
      }
  ...
  public AssignmentDistributionSearch deepCopy() {
    return new AssignmentDistributionSearch(this);
  }
  ...
  public AssignmentDistributionSearch setPid(int pid) {
    this.pid = pid;
    setPidIsSet(true);
    return this;
  }
  ...
  public AssignmentDistributionSearch setProjectName(String projectName) {
    this.projectName = projectName;
    return this;
  }
  ...
  public AssignmentDistributionSearch setProjectNum(String projectNum) {
    this.projectNum = projectNum;
    return this;
  }
  ...
  public AssignmentDistributionSearch setCusName(String cusName) {
    this.cusName = cusName;
    return this;
  }
  ...
  public AssignmentDistributionSearch setEcoTrade(int ecoTrade) {
    this.ecoTrade = ecoTrade;
    setEcoTradeIsSet(true);
    return this;
  }
  ...
  public AssignmentDistributionSearch setExpireStartDt(String expireStartDt) {
    this.expireStartDt = expireStartDt;
    return this;
  }
  ...
  public AssignmentDistributionSearch setExpireEndt(String expireEndt) {
    this.expireEndt = expireEndt;
    return this;
  }
  ...
  public AssignmentDistributionSearch setOverdueStartDay(int overdueStartDay) {
    this.overdueStartDay = overdueStartDay;
    setOverdueStartDayIsSet(true);
    return this;
  }
  ...
  public AssignmentDistributionSearch setOverdueEndDay(int overdueEndDay) {
    this.overdueEndDay = overdueEndDay;
    setOverdueEndDayIsSet(true);
    return this;
  }
  ...
  public AssignmentDistributionSearch setRequestStartDt(String requestStartDt) {
    this.requestStartDt = requestStartDt;
    return this;
  }
  ...
  public AssignmentDistributionSearch setRequestEndDT(String requestEndDT) {
    this.requestEndDT = requestEndDT;
    return this;
  }
  ...
  public AssignmentDistributionSearch setReminderStatus(int reminderStatus) {
    this.reminderStatus = reminderStatus;
    setReminderStatusIsSet(true);
    return this;
  }
  ...
  public AssignmentDistributionSearch setCollectionUser(String collectionUser) {
    this.collectionUser = collectionUser;
    return this;
  }

  public void unsetCollectionUser() {
    this.collectionUser = null;
  }

  /** Returns true if field collectionUser is set (has been assigned a value) and false otherwise */
  public boolean isSetCollectionUser() {
    return this.collectionUser != null;
  }

  public void setCollectionUserIsSet(boolean value) {
    if (!value) {
      this.collectionUser = null;
    }
  }
  ...
  public AssignmentDistributionSearch setAcctType(int acctType) {
    this.acctType = acctType;
    setAcctTypeIsSet(true);
    return this;
  }
  ...
  public AssignmentDistributionSearch setPlanStartDt(String planStartDt) {
    this.planStartDt = planStartDt;
    return this;
  }
  ...
  public AssignmentDistributionSearch setPlanEndDT(String planEndDT) {
    this.planEndDT = planEndDT;
    return this;
  }
  ...
  public java.util.Iterator<AssignmentDistribution> getResultsIterator() {
    return (this.results == null) ? null : this.results.iterator();
  }

  public void addToResults(AssignmentDistribution elem) {
    if (this.results == null) {
      this.results = new ArrayList<AssignmentDistribution>();
    }
    this.results.add(elem);
  }

  public List<AssignmentDistribution> getResults() {
    return this.results;
  }

  public AssignmentDistributionSearch setResults(List<AssignmentDistribution> results) {
    this.results = results;
    return this;
  }
  ...
  public AssignmentDistributionSearch setRows(int rows) {
    this.rows = rows;
    setRowsIsSet(true);
    return this;
  }
  ...
  public AssignmentDistributionSearch setPage(int page) {
    this.page = page;
    setPageIsSet(true);
    return this;
  }
  ...
  public AssignmentDistributionSearch setIndexStart(int indexStart) {
    this.indexStart = indexStart;
    setIndexStartIsSet(true);
    return this;
  }
  ...
  public AssignmentDistributionSearch setIndexEnd(int indexEnd) {
    this.indexEnd = indexEnd;
    setIndexEndIsSet(true);
    return this;
  }
  ...
  public void setFieldValue(_Fields field, Object value) {
    ...
    case COLLECTION_USER:
      if (value == null) {
        ...
        setCollectionUser((String)value);
      }
      break;
    ...
    case RESULTS:
      if (value == null) {
        ...
        setResults((List<AssignmentDistribution>)value);
      }
      break;
  ...
  public boolean equals(Object that) {
    if (that == null)
      return false;
    if (that instanceof AssignmentDistributionSearch)
      return this.equals((AssignmentDistributionSearch)that);
    return false;
  }

  public boolean equals(AssignmentDistributionSearch that) {
    if (that == null)
      return false;
    ...
    boolean this_present_collectionUser = true && this.isSetCollectionUser();
    boolean that_present_collectionUser = true && that.isSetCollectionUser();
    if (this_present_collectionUser || that_present_collectionUser) {
      if (!(this_present_collectionUser && that_present_collectionUser))
        return false;
      if (!this.collectionUser.equals(that.collectionUser))
        return false;
    }
  ...
  public int hashCode() {
    ...
    boolean present_collectionUser = true && (isSetCollectionUser());
    list.add(present_collectionUser);
    if (present_collectionUser)
      list.add(collectionUser);
  ...
  @Override
  public int compareTo(AssignmentDistributionSearch other) {
    ...
    lastComparison = Boolean.valueOf(isSetCollectionUser()).compareTo(other.isSetCollectionUser());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetCollectionUser()) {
      lastComparison = org.apache.thrift.TBaseHelper.compareTo(this.collectionUser, other.collectionUser);
      if (lastComparison != 0) {
        return lastComparison;
      }
    }
  ...
  public String toString() {
    StringBuilder sb = new StringBuilder("AssignmentDistributionSearch(");
    boolean first = true;
    ...
    first = false;
    if (!first) sb.append(", ");
    sb.append("collectionUser:");
    if (this.collectionUser == null) {
      sb.append("null");
    } else {
  ...
  private static class AssignmentDistributionSearchStandardSchemeFactory implements SchemeFactory {
    public AssignmentDistributionSearchStandardScheme getScheme() {
      return new AssignmentDistributionSearchStandardScheme();
    }
  }

  private static class AssignmentDistributionSearchStandardScheme extends StandardScheme<AssignmentDistributionSearch> {

    public void read(org.apache.thrift.protocol.TProtocol iprot, AssignmentDistributionSearch struct) throws org.apache.thrift.TException {
      ...
      while (true)
      {
        ...
        switch (schemeField.id) {
          ...
          case 13: // COLLECTION_USER
            if (schemeField.type == org.apache.thrift.protocol.TType.STRING) {
              struct.collectionUser = iprot.readString();
              struct.setCollectionUserIsSet(true);
            } else { 
              org.apache.thrift.protocol.TProtocolUtil.skip(iprot, schemeField.type);
            }
            break;
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.results = new ArrayList<AssignmentDistribution>(_list24.size);
                AssignmentDistribution _elem25;
                for (int _i26 = 0; _i26 < _list24.size; ++_i26)
                {
                  _elem25 = new AssignmentDistribution();
                  _elem25.read(iprot);
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, AssignmentDistributionSearch struct) throws org.apache.thrift.TException {
      struct.validate();
      ...
      oprot.writeFieldEnd();
      if (struct.collectionUser != null) {
        oprot.writeFieldBegin(COLLECTION_USER_FIELD_DESC);
        oprot.writeString(struct.collectionUser);
        oprot.writeFieldEnd();
      }
      ...
      if (struct.results != null) {
        oprot.writeFieldBegin(RESULTS_FIELD_DESC);
        {
          ...
          for (AssignmentDistribution _iter27 : struct.results)
          {
            _iter27.write(oprot);
          }
          oprot.writeListEnd();
  ...
  private static class AssignmentDistributionSearchTupleSchemeFactory implements SchemeFactory {
    public AssignmentDistributionSearchTupleScheme getScheme() {
      return new AssignmentDistributionSearchTupleScheme();
    }
  }

  private static class AssignmentDistributionSearchTupleScheme extends TupleScheme<AssignmentDistributionSearch> {

    @Override
    public void write(org.apache.thrift.protocol.TProtocol prot, AssignmentDistributionSearch struct) throws org.apache.thrift.TException {
      ...
      if (struct.isSetResults()) {
        {
          ...
          for (AssignmentDistribution _iter28 : struct.results)
          {
            _iter28.write(oprot);
          }
        }
    ...
    @Override
    public void read(org.apache.thrift.protocol.TProtocol prot, AssignmentDistributionSearch struct) throws org.apache.thrift.TException {
      ...
      if (incoming.get(16)) {
        {
          ...
          struct.results = new ArrayList<AssignmentDistribution>(_list29.size);
          AssignmentDistribution _elem30;
          for (int _i31 = 0; _i31 < _list29.size; ++_i31)
          {
            _elem30 = new AssignmentDistribution();
            _elem30.read(iprot);
