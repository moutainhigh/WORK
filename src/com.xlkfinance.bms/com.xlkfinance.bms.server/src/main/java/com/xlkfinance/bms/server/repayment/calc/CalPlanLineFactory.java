...
@Component("repaymentCalPlanLineFactory")
public class CalPlanLineFactory {
	
	@Resource(name = "repaymentMonthInterestCalPlanLine")
	private CalPlanLine monthInterestCalPlanLine;

	@Resource(name = "repaymentDayInterestCalPlanLine")
	private CalPlanLine dayInterestCalPlanLine;
	
	@Resource(name = "repaymentEqInterestCalPlanLine")
	private CalPlanLine eqInterestCalPlanLine;

	@Resource(name = "repaymentEqPrincipalCalPlanLine")
	private CalPlanLine eqPrincipalCalPlanLine;
	
	@Resource(name = "repaymentEqPrincipalInterestCalPlanLine")
	private CalPlanLine eqPrincipalInterestCalPlanLine;
	
	@Resource(name = "repaymentOtherWayCalPlanLine")
