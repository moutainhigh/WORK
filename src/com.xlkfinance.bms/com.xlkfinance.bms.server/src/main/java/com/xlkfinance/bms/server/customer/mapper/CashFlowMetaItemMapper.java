...
@MapperScan("CashFlowMetaItemMapper")
public interface CashFlowMetaItemMapper<T, PK>  extends BaseMapper<T, PK>{

	public List<FinacialDTO> getAllCusComCaseFlowMeta(CashFlowItem cashFlowItem);
