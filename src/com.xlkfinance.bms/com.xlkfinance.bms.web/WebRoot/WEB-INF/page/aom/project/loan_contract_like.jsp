...
<div class="contract_dis" style="padding: 10px;width:1039px;">
		...
		<div id="contractList22" style="height:225px ">	
			...
			<div class="contractListDiv" style="height:225px">
				<table id="grid_contract22" class="easyui-datagrid" 
							style="height:100%;width: auto;"
							data-options="
							    url: '${basePath}creditsContractController/getContractListUrl.action?customerType=1&projectId=${projectId }&contractCatelogKey=DY',
							    method: 'POST',
							    rownumbers: true,
							    singleSelect: false,
							    pagination: true,
		...
		<div id="contractList33" style="height:225px;padding-top: 10px;">				
			...
			<div class="contractListDiv" style="height:100%">
				<table id="grid_contract33" class="easyui-datagrid" 
							style="height:100%;width: auto;"
							data-options="
							    url: '${basePath}creditsContractController/getContractListUrl.action?customerType=1&projectId=${projectId }&contractCatelogKey=ZY',
							    method: 'POST',
							    rownumbers: true,
							    singleSelect: false,
							    pagination: true,
			...
			<div id="toolbar44" class="easyui-panel" >
				<form action="perListUrl.action" method="post" id="searchFrom44">
					...
					<table>
						<tr>
							<td>【保证合同】： </td>
							<td width="60"><input name="customerType" type="radio" value="1" onchange="changeEvent('BZ',1)" checked="checked" > 最高额</td>
							<td width="60"><input name="customerType" type="radio" value="2" onchange="changeEvent('BZ',2)"> 单笔</td>
						 </tr>
					</table>
					</div>
				</form>
				...
				<a href="javascript:void(0)" class="easyui-linkbutton" iconCls="icon-edit" plain="true" onclick="editCreditContract('BZ')">编辑</a>
				<a href="javascript:void(0)" class="easyui-linkbutton" iconCls="icon-remove" plain="true" onclick="deleteCreditContract('BZ')">删除</a>
			</div>
			<div class="contractListDiv" style="height:100%">
				<table id="grid_contract44" class="easyui-datagrid" 
							style="height:100%;width: auto;"
							data-options="
							    url: '${basePath}creditsContractController/getContractListUrl.action?customerType=1&projectId=${projectId }&contractCatelogKey=BZ',
							    method: 'POST',
							    rownumbers: true,
							    singleSelect: false,
							    pagination: true,
