<%@page language="java" pageEncoding="UTF-8" contentType="text/html; charset=UTF-8"%>
	...
	<div id="mortgageNews">
		...
		<%-- 抵押信息列表 --%>
		<div id="dyxxDiv" style="padding-left: 10px;" >
		    <table id="dyxx_grid" class="easyui-datagrid" style="width: auto;height: auto;"	    	
			 	data-options="
				 	url: '<%=basePath%>mortgageController/getProjectAssBaseByMortgageGuaranteeType.action?projectId='+newProjectId+'&mortgageGuaranteeType=1&oldProject='+extension.hisProjectIds,
				    method: 'POST',
				    singleSelect: false,
				    sortOrder:'asc',
				    remoteSort:false,
	...
	<div id="pledgeNews">
		...
		<div id="zyxxDiv" style="padding-left: 20px;" >
		    <table id="zyxx_grid" class="easyui-datagrid" style="width: auto;height: auto;"	    	
			 	data-options="
					url: '<%=basePath%>mortgageController/getProjectAssBaseByMortgageGuaranteeType.action?projectId='+newProjectId+'&mortgageGuaranteeType=2&oldProject='+extension.hisProjectIds,
				    method: 'POST',
				    singleSelect: false,
				    sortOrder:'asc',
				    remoteSort:false,
		...
		<div id="personalGuarantee_div" style="padding-left: 20px;" >
			<table id="perGuarantee_grid" class="easyui-datagrid"  
		    	style="height: auto;width: auto;"
			 	data-options="
				    url: '<%=basePath%>secondBeforeLoanController/getProjectAssureByPersonal.action?projectId='+newProjectId+'&oldProject='+extension.hisProjectIds,
				    method: 'post',
				    rownumbers: true,
				    singleSelect: false,
	...
	<div id="corporationGuaranteeNews">
		...
		<div id="corporationGuarantee_div" style="padding-left: 20px;" >
			<table id="corGuarantee_grid" class="easyui-datagrid"  
		    	style="height: auto;width: auto;"
			 	data-options="
			    url: '<%=basePath%>secondBeforeLoanController/getProjectAssureByEnterprise.action?projectId='+newProjectId+'&oldProject='+extension.hisProjectIds,
			    method: 'post',
			    rownumbers: true,
			    singleSelect: false,
	...
	<div id="dlg_dzywxx" class="easyui-dialog" fitColumns="true"  buttons="#dlg_buttons_dzywxx" 
		...
		<table id="table_dzywxx">
			...
			<tr>
				...
				<td>
					<input name="assessValue" id="assessValue" class="easyui-numberbox" data-options="onChange:extension.mortgageValueInfo" precision="2" required="true" groupSeparator="," missingMessage="请录入评估净值!"  />				
				</td>
			</tr>
			<tr>
				...
				<td>
					<input name="mortgageRate" readonly id="mortgageRate" class="easyui-numberbox" precision="4"  /> %				
				</td>
			</tr>
			<tr>
	...
	<script type="text/javascript">
		...
		function saveOwnName(){
	 	...
	 	// 建筑面积
			...
			// 判断是否退出方法
	 		if(bool){
	 			$.messager.alert('操作提示',"必须填写建筑面积信息,请输入!",'error');
				return;
	 		}
	 		// 赋值抵质押物详细信息
