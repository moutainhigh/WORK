...
<%@ include file="/config.jsp"%>
	<div class="datum" style="padding: 30px 10px 10px 10px;width:1039px">
		<div id="toolbar_data">
	...
	function lookfor(){
		...
		if("task_ExtensionRequest"==workflowTaskDefKey || "task_ApprovalOfficerReview"==workflowTaskDefKey ||"task_OfflineMeetingResult"==workflowTaskDefKey){
		}else{
			fromDisable();
		}
	}
