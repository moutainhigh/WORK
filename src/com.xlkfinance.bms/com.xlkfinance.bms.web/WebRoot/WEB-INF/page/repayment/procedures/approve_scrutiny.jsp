<%@ page language="java" pageEncoding="UTF-8" contentType="text/html; charset=UTF-8"%>
	...
	<div  class="easyui-panel control_disappr" data-options="collapsible:true" style="padding:10px" title="审批官审批信息" style="width:auto">
		<!--图标按钮 -->
		<div id="fkqlstjToolbar" class="easyui-panel" style="border-bottom: 0;display:none">
			<!-- 操作按钮 -->
		...
		<div id ="dksqListDiv" class="dksqListDiv" style="height:auto;width: auto;display:none">
