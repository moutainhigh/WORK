	...
	$(document).ready(function() {
		...
		/* $('#projectFileArchive').datagrid({
			onLoadSuccess:function(){ 
				if("task_ProjectArchive"==workflowTaskDefKey && biaoZhi!=3){//项目归档
					...
					$('.projectFileArchivePaper .easyui-linkbutton:not(.download) ,.projectFileArchivePaper a:not(.download)').removeAttr('onclick');
					$('.projectFileArchivePaper a:not(.download) font').attr('color','gray');
					$('.projectFileArchivePaper a:not(.download) span').css('color','gray');
					$('.projectFileArchivePaper .easyui-linkbutton:not(.download) ,.projectFileArchivePaper  input,.projectFileArchivePaper  textarea').attr('disabled','disabled');
					$('.projectFileArchivePaper .easyui-linkbutton:not(.download) ,.projectFileArchivePaper  input,.projectFileArchivePaper  textarea').attr('readOnly','readOnly');
					$('.projectFileArchivePaper a:not(.download),.projectFileArchivePaper .easyui-linkbutton:not(.download) ,.projectFileArchivePaper  input,.projectFileArchivePaper  textarea').addClass('l-btn-disabled');
				}
			}
		}) */
	});
		...
		<table align="center" cellpadding="5" style="height: auto;">
			...
			<tr>
				<td colspan="4" align="center">
					...
					<a href="javascript:void(0)" id="lastStepCloseButton" iconcls="icon-cancel" class="easyui-linkbutton download" onclick="closeProjectFileArchiveInfoForm()">关闭</a>
					</div>
				</td>
			</tr>
		</table>
