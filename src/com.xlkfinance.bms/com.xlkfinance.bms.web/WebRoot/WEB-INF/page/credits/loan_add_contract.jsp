...
<style>
 ...
 <div class="contract_dis">
	<div  style="padding: 10px 10px 10px 10px;width:1039px;">
			<div id="contractList">
				...
				<div class="contractListDiv" id="creditContractDiv">
					<table id="grid_contract" title="授信合同" class="easyui-datagrid" 
						...
						data-options="
						    url: '${basePath}creditsContractController/getContractListUrl.action?projectId='+newProjectId+'&contractCatelogKey=SX,DK&oldProjectId='+projectId,
						    method: 'POST',
						    collapsible:true,
						    rownumbers: true,
						    singleSelect: false,
	...
	<div id="editContractDialog" class="easyui-dialog" style="width:850px;height:400px;" closed="true" buttons="#edit_template-buttons">
    <center> 
...
<script type="text/javascript">
	...
	function ajaxContract(){
		...
		loadProjectContract("templateDialog",contractType,tempLateId,newProjectId,projectId,newProjectId,mortgagorId,suretyId,-1,mortgagorType,commonDebtorPids,assBaseIds);
	...
	function saveCreditContract(){
		...
		if(checkContractCount(newProjectId,tempLateId,1)){
			$.messager.alert("操作提示", "一个项目不能新增多个授信合同!", "error");
			return;
		}
		
		if(checkContractCount(newProjectId,tempLateId,2)){
	...
	function changeEvent(mcontracType,str){
		mgridType(mcontracType);
		$(mgrid).datagrid({url:"${basePath}beforeLoanController/getContractListUrl.action?customerType="+str+"&projectId="+newProjectId+"&contractCatelogKey="+contractCatelog }); 
	...
	$(document).ready(function(){
		...
		if("task_CreditWithdrawalRequest"==workflowTaskDefKey || "task_ApprovalOfficerReview"==workflowTaskDefKey ||"task_OfflineMeetingResult"==workflowTaskDefKey||"task_ContractSign"==workflowTaskDefKey){
