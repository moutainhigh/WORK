...
<script type="text/javascript" src="${ctx}/p/xlkfinance/module/repayment/extensionApply/list_foreLoanExtension.js?version=20161230"></script>
<style type="text/css">
</style>
	...
	<table id="grid" title="贷款展期" class="easyui-datagrid"
		...
		<thead>
			<tr>
				...
				<th data-options="field:'creditAmt',width:'100',align:'right',formatter:formatMoney">借款金额</th>
				<th data-options="field:'pmUserName',width:'100'">客户经理</th>
