...
<body class="easyui-layout">
	...
	<div id="toolbar" class="easyui-panel" style="border-bottom: 0;">
		<form action="<%=basePath%>refundFeeController/list.action?type=1" method="post" id="searchFrom" name="searchFrom" >
			<!-- 查询条件 -->
	...
	<table id="grid" title="退手续费申请列表" class="easyui-datagrid" 
		style="height:100%;width: auto;"
		data-options="
		    url: '<%=basePath%>refundFeeController/list.action?type=1',
		    method: 'POST',
		    rownumbers: true,
		    singleSelect: true,
		    pagination: true,
   ...
   <form id="refundFeeConfirmForm" name="refundFeeConfirmForm" action="${basePath}refundFeeController/refundFeeConfirm.action" method="post">
     <table style="width: 90%; height: 100px;">
      <tr>
       ...
       <td><input name="returnFee" id="returnFee" class="easyui-numberbox"
        data-options="min:0,max:9999999999,precision:2,groupSeparator:','" disabled="disabled"  style="width:247px;"
       ></td>
      </tr>
      <tr>
       <td class="label_right1">确认金额：</td>
       <td><input name="confirmMoney" id="confirmMoney" class="easyui-numberbox"
        data-options="min:0,max:9999999999,precision:2,groupSeparator:','"  style="width:247px;"
       ></td>
      </tr>
      <tr>
       <td class="label_right1">确认日期：</td>
       <td>
       <input name="confirmDate" id="confirmDate" data-options="validType:'selrequired'" class="easyui-datebox" editable="false" panelHeight="auto" required="true" style="width: 250px;"/>
       </td>
      </tr>
     </table>
     <input type="hidden" name="type" value="1">
     <input type="hidden" name="projectId" id="refundFeeConfirmProjectId">
    </form>
   </div>
   <div id="submitDiv1">
    <a id="F" href="javascript:void(0)" class="easyui-linkbutton" iconCls="icon-ok" onclick="subRefundFeeConfirmForm()">提交</a> 
    <a href="javascript:void(0)" class="easyui-linkbutton" iconCls="icon-cancel" onclick="javascript:$('#refund_fee_confirm_dialog').dialog('close')">取消</a>
   </div>
	</div>
</div>
