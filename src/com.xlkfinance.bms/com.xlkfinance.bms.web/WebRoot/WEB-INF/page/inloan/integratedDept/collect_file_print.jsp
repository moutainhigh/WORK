...
var printType=${collectFilePrintInfo.printType};
...
$(document).ready(function() {
	if (printType==1) {
	    $.ajax({
			...
			cache : true,
			type : "POST",
			data : {'projectId' : projectId,'buyerSellerType' : buyerSellerType,'buyerSellerName' : buyerSellerName},
			async : false,
...
<div id="myPrintArea">
 <table width="100%" border="0" cellspacing="0" cellpadding="0" class="table_css" style="margin-bottom: 10px;">
  ...
  <tr>
   <td colspan="3"><input type="checkbox" value="PAYMENT_NAME" id="PAYMENT_NAME" name="collectFileMapList[33].code"><b>回款账户名： </b><span
    id="PAYMENT_NAME_REMARK"></span></td>
  </tr>
  
  <tr>
   <td colspan="3"><input type="checkbox" value="ID_CARD_NUMBER" id="ID_CARD_NUMBER" name="collectFileMapList[34].code"><b>回款人身份证： </b><span
    id="ID_CARD_NUMBER_REMARK"></span></td>
  </tr>
  
   <td colspan="3"><input type="checkbox" value="BANK_CARD" id="BANK_CARD" name="collectFileMapList[3].code"><b>银行卡/折： </b><span
    id="BANK_CARD_REMARK"></span></td>
  </tr>
 ...
 <table width="100%" border="0" cellspacing="0" cellpadding="0" class="table_css" style="margin-bottom: 30px;">
  <tr>
   <td height="20" valign="top"><b>借款金额：</b>${collectFilePrintInfo.printLoanMoney }</td>
   <td valign="top"><b>银行放款金额：</b>${collectFilePrintInfo.realLoanMoney }</td>
   <td valign="top"><b>赎楼金额：</b>${collectFilePrintInfo.foreclosureMoney }</td>
  </tr>
  <tr>
   <td height="30" valign="top"><b>退尾款金额：</b>${collectFilePrintInfo.refundTailMoney }</td>
   <td valign="top"><b>银行卡内余额：</b></td>
   <td valign="top"></td>
  </tr>
