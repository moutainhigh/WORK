<%@page language="java" pageEncoding="UTF-8" contentType="text/html; charset=UTF-8"%>
	...
	<div id="dlg_buttons_tqsq">
	    <a href="javascript:void(0)" class="easyui-linkbutton" iconCls="icon-save" onclick="saveMortgageOperation(2,'#tqsqForm','#dlg_tqsq')">保存</a>
	    <a href="javascript:void(0)" class="easyui-linkbutton" iconCls="icon-cancel" onclick="javascript:$('#dlg_tqsq').dialog('close')">关闭</a>
	</div>
	
	<%-- 抵质押物提取申请 --%>
	<div id="dlg_tqsq" class="easyui-dialog" fitColumns="true"  buttons="#dlg_buttons_tqsq" 
	 	style="width:850px;height:480px;padding: 10px;" data-options="modal:true" closed="true"  >
		<h4>抵质押物提取申请</h4>
		<hr />
		<form id="tqsqForm" method="post" >
			<input type="hidden" name="pid" />
			<input type="hidden" name="extractionId" />
			<table>
				<tr>
				...
				<tr>
					...
					<td colspan="3">
						<input id="objectLocation_tqsq" type="text" class="no_frame text_style" disabled="true" style="width: 510px;" />
					</td>
				</tr>
				<tr>
				...
				<tr>
					...
					<td colspan="3">
						<input name="extRequestReason" class="easyui-textbox" style="width:510px;height:60px" data-options="multiline:true" />
					</td>
				</tr>
			</table>
			...
			<div id="tqsq_toolbar">
				<div style="padding-bottom:5px">
					<a href="javascript:void(0)" class="easyui-linkbutton" iconCls="icon-add" plain="true"  onclick="insertFileDizhiya('提取抵押申请类型','#tqsqForm')">新增</a>
					<a href="javascript:void(0)" class="easyui-linkbutton" iconCls="icon-edit" plain="true" onclick="delFileDizhiya('#tqsq-datagrid')">删除</a>
				</div>
			</div>
			<table id="tqsq-datagrid" class="easyui-datagrid" style="width:750px;height:200px;"
				data-options="
						url: '',
					    method: 'POST',
					    rownumbers: true,
					    singleSelect: false,
					    toolbar: '#tqsq_toolbar',
					    idField: 'pid',
					    fitColumns:true ">
				<thead>
					...
					<th data-options="field:'cz',formatter:doFileterTqsq" >操作</th>
				</thead>
			</table>
		</form>
	</div>
	...
	<script type="text/javascript">
		...
		function doFileterTqsq(value,row,index){
