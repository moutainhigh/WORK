<%@page language="java" pageEncoding="UTF-8" contentType="text/html; charset=UTF-8"%>
	...
	<div id="mortgageNews">
		...
		<div id="dyxxDiv" style="padding-left: 20px;" >
		    <table id="dyxx_grid" class="easyui-datagrid" style="width: auto;height: auto;"	    	
			 	data-options="
				 	url: '<%=basePath%>mortgageController/getProjectAssBaseByMortgageGuaranteeType.action?projectId='+projectId+'&mortgageGuaranteeType=1&oldProject=-1',
				    method: 'POST',
				    singleSelect: false,
				    sortOrder:'asc',
				    remoteSort:false,
	...
	<div id="pledgeNews">
		...
		<div id="zyxxDiv" style="padding-left: 20px;" >
		    <table id="zyxx_grid" class="easyui-datagrid" style="width: auto;height: auto;"	    	
			 	data-options="
					url: '<%=basePath%>mortgageController/getProjectAssBaseByMortgageGuaranteeType.action?projectId='+projectId+'&mortgageGuaranteeType=2&oldProject=-1',
				    method: 'POST',
				    singleSelect: false,
				    sortOrder:'asc',
				    remoteSort:false,
		...
		<div id="personalGuarantee_div" style="padding-left: 20px;" >
			<table id="perGuarantee_grid" class="easyui-datagrid"  
		    	style="height: auto;width: auto;"
			 	data-options="
				    url: '<%=basePath%>secondBeforeLoanController/getProjectAssureByPersonal.action?projectId='+projectId+'&oldProject=-1',
				    method: 'post',
				    rownumbers: true,
				    singleSelect: false,
	...
	<div id="corporationGuaranteeNews">
		...
		<div id="corporationGuarantee_div" style="padding-left: 20px;" >
			<table id="corGuarantee_grid" class="easyui-datagrid"  
		    	style="height: auto;width: auto;"
			 	data-options="
			    url: '<%=basePath%>secondBeforeLoanController/getProjectAssureByEnterprise.action?projectId='+projectId+'&oldProject=-1',
			    method: 'post',
			    rownumbers: true,
			    singleSelect: false,
	...
	<div id="dlg_dzywxx" class="easyui-dialog" fitColumns="true"  buttons="#dlg_buttons_dzywxx" 
		...
		<table id="table_dzywxx">
			...
			<tr>
				...
				<td>
					<input name="assessValue"  id="assessValue" class="easyui-numberbox"  data-options="onChange:applyCommon.mortgageValueInfo"  precision="2" required="true" groupSeparator="," missingMessage="请录入评估净值!"  />				
				</td>
			</tr>
			<tr>
				...
				<td>
					<input name="mortgageRate" id="mortgageRate" readonly class="easyui-numberbox" precision="4" /> %				
				</td>
			</tr>
			<tr>
	...
	<div id="dlg-buttons_personalGuarantee">		
	    <a href="javascript:void(0)" class="easyui-linkbutton" iconCls="icon-save" onclick="saveProjectAssure(1,projectId)">选择</a>
	</div>
	...
	<div id="dlg-buttons_corporationGuarantee">
	    <a href="javascript:void(0)" class="easyui-linkbutton" iconCls="icon-save" onclick="saveProjectAssure(2,projectId)">选择</a>
	</div>
	<%-- 企业法人选取 --%>
				 		...
				 		<tr>
				 			...
				 			<td colspan="2">
					 			<div class="ecoTradeId100">
					 				<table>
										<tr>
								 			<td class="label_right" style="width: 100px;">经济行业类别：</td>
