...
function cxportDifferWarn() {
	...
	$
			.ajax({
				...
				data : {
					templateName : 'REFUND_TAIL_MONEY'
				},
				dataType : 'json',
				success : function(data) {
					if (data == 1) {
						window.location.href = "${basePath}reportController/refundFeeExcelExportList.action?projectIds="
								+ projectIds + "&templateName=REFUND_TAIL_MONEY";
					} else {
						alert('退尾款报表的导出模板不存在，请上传模板后重试');
					}
				}
			})
}
 ...
 <div data-options="region:'center',border:false">
  <div id="scroll-bar-div">
   ...
   <div id="toolbar" class="easyui-panel" style="border-bottom: 0;">
    <form action="<%=basePath%>reportController/reportList.action?type=3" method="post" id="searchFrom" name="searchFrom">
     <!-- 查询条件 -->
    ...
    <div style="padding-bottom: 5px">
    	<shiro:hasAnyRoles name="REFUND_TAIL_MONEY,ALL_BUSINESS">
   ...
   <div class="dksqListDiv" style="height: 100%;">
    <table id="grid" title="退尾款统计" class="easyui-datagrid" style="height: 100%; width: auto;"
     data-options="
		    url: '<%=basePath%>reportController/reportList.action?type=3',
		    method: 'POST',
		    rownumbers: true,
		    singleSelect:false,
		    pagination: true,
    ...
    >
     ...
     <thead><tr>
		    ...
		    <th data-options="field:'recAccountName',sortable:true" align="center" halign="center">收余款账户</th>
		    <th data-options="field:'loanMoney',sortable:true,formatter:formatMoney" align="center" halign="center">担保金额</th>
		    <th data-options="field:'confirmMoney',sortable:true,formatter:formatMoney" align="center" halign="center">到账金额</th>
		    <th data-options="field:'foreclosureFloorMoney',sortable:true,formatter:formatMoney" align="center" halign="center">赎楼金额</th>
		    <th data-options="field:'backFeeApplyHandleStatus',sortable:true,formatter:formatterBackFeeApplyHandleStatus" align="center" halign="center">退余款状态</th>
