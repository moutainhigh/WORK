		...
		<form action="<%=basePath%>beforeLoanController/saveApplyInfo.action" id="applyInfoForm" name="applyInfoForm" method="post" >
			...
			<div style="padding-left: 10px;padding-top:10px;height: auto;line-height: 35px;" >
				...
				<tr>
					...
					<td>
						 <input name="contactPhone" class="easyui-textbox" data-options="required:true,validType:'telephone'" missingMessage="请填写联系电话!" value="${applyHandleInfo.contactPhone }"/>
					</td>
				</tr>
				<tr>
					<td class="label_right">特殊情况说明：</td>
					<td colspan="3">
						<input name="specialCase" value="${applyHandleInfo.specialCase }" id="specialCase" class="easyui-textbox" style="width:65%;height:60px" data-options="multiline:true,validType:'length[0,500]'">
					</td>
				</tr>
				<tr>
					<td class="label_right">备注：</td>
					<td colspan="3">
						 <input name="remark" id="remark" value="${applyHandleInfo.remark }"  class="easyui-textbox" style="width:65%;height:60px" data-options="multiline:true,validType:'length[0,500]'">
					</td>
				</tr>
			</table>
			</div>
