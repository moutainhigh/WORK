...
$(document).ready(function(){
	$("#grid_loadZy").datagrid({url:"<%=basePath%>mortgageController/getProjectAssBaseByMortgageGuaranteeType.action?projectId="+projectId+"&mortgageGuaranteeType=-1&oldProject=-1" });
	...
	$(document).ready(function(){
		$('#grid_loadZy').datagrid({
			onLoadSuccess:function(){
				...
				var rows = $('#grid_loadZy').datagrid('getData').total;
				if(rows==0){
					$('.dizhiya_panel_none').hide();
				}
			}
		})
	})
