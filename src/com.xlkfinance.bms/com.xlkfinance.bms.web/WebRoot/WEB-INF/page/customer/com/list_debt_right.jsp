...
function addItem(){
	   $('<div id="editComDebt"/>').dialog({
			href : '${basePath}customerController/editComDebt.action?comId=${comId}&acctId=${acctId}&debtType=${debtType}',
			width : 890,
			height : 385,
			modal : true,
			title : '新增债务管理信息',
	...
	function editItem(){
	   ...
	   if (row.length == 0) {
	 	...
	 	if (row.length == 1) {
	 		 var pid=row[0].pid;
	 		  $('<div id="editComDebt"/>').dialog({
	 				href : '${basePath}customerController/editComDebt.action?comId=${comId}&acctId=${acctId}&pid='+pid,
	 				width : 890,
	 				height : 385,
	 				modal : true,
	 				title : '编辑债务管理信息 ',
...
<table id="grid" title="债务情况" class="easyui-datagrid" 
	style="height:450px;width: auto;"
	data-options="
	    url: 'searchlistComDebt.action?debtType=${debtType}&comId=${comId}',
	    method: 'get',
	    rownumbers: true,
	    singleSelect: true,
	    pagination: true,
	...
	<thead><tr>
	    ...
	    <th data-options="field:'value1',width:100,sortable:true"  >债务人</th>
	    ...
	    <th data-options="field:'value5',width:200,sortable:true" >月还款额</th>
	    <th data-options="field:'value6',width:200,sortable:true" >借款截止日期</th>
	    <th data-options="field:'value7',width:200,sortable:true" >偿还方式</th>
	    <th data-options="field:'value8',width:200,sortable:true" >担保方式</th>
	    <th data-options="field:'value9',width:200,sortable:true" hidden="true" ></th>
	</tr></thead>
</table>
</div>
</div>
