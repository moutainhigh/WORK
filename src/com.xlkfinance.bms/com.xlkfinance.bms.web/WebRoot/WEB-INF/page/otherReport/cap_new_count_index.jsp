		...
		$.ajax({url : BASE_PATH
					...
					success : function(data) {
						if (data == 1) {
							...
							window.location.href ="${basePath}otherReportController/capNewCountExportList.action?chooseMonthOrWeek="+mothOrWekNum+"&reMonth="+reMonth+
							"&pmUserName="+pmUserName+"&projectNumber="+projectNumber+"&projectName="+projectName+"&orgName="+orgName+"&page=-1";
						} else {
							alert('赎楼贷资金方已放款的导出模板不存在....，请上传模板后重试');
						}
					}
				})
	}
 ...
 <div data-options="region:'center',border:false">
  <div id="scroll-bar-div">
   ...
   <div id="toolbar" class="easyui-panel" style="border-bottom: 0;">
    <form action="<%=basePath%>otherReportController/capNewCountList.action" method="post" id="searchFrom" name="searchFrom">
     <!-- 查询条件 -->
   ...
   <div class="dksqListDiv" style="height: 100%;">
    <table id="grid" title="赎楼贷资金方已放款详情列表" class="easyui-datagrid" style="height: 100%; width: auto;"
     data-options="
		    url: '<%=basePath%>otherReportController/capNewCountList.action?mothOrWekNum='+${mothOrWekNum}+'&reMonth='+reMonth+'&orgName='+orgName,
		    method: 'POST',
		    rownumbers: true,
		    singleSelect: false,
		    pagination: true,
