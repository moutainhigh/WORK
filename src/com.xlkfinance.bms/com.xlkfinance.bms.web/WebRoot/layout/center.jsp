...
$(function() {
	$('#layout_center_tabsMenu').menu({
		onClick : function(item) {
			...
			//
			//var allTabs1 = $('#layout_center_tabs1').tabs('tabs');
...
<div id="layout_center_tabs" class="welcometab" style="overflow: hidden;">

	
	<!-- <div title="资金头寸报表" data-options="href:'<%=basePath %>/financeTransactionController/getTransactionList.action'"></div>-->
