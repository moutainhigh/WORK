...
public class MoneyUtil {
     ...
     //added by Linda 20090826 begin
	    boolean b = false;
	    if(str.startsWith("-")){
	    	 b = true;
	    	 str = str.replace("-", "");
      }
	  //added by Linda 20090826 end
	  ...
	  private static String getChineseDecimal(int[] decimals) {
	    ...
	    for (int i = 0; i < decimals.length; i++) {
	      ...
	      if (i == 3)
	        break;
	       //chineseDecimal.append(decimals[i] == 0 ? "零" : (NUMBERS[decimals[i]] + DUNIT[i]));
	        if (i == 0 && decimals[i] == 0) {
